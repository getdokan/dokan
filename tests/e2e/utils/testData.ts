...
export const data = {
	...
	auth: { adminAuthFile: 'playwright/.auth/adminStorageState.json',
	...
	user: { username: ()=> faker.name.firstName('male'),
		userDetails: { firstName: ()=> faker.name.firstName('male'),
			lastName: ()=> faker.name.lastName('male'),
			role: 'customer', }, },

	product: { publishSuccessMessage: 'Product published. ',
		...
		name: { simple: ()=> faker.commerce.productName() + (' (Simple)'),
			...
			dokanSubscription: { nonRecurring: ()=> 'Dokan Subscription ' + faker.helpers.arrayElement(['Gold', 'Silver', 'Platinum', 'Premium'],) + ' ' + faker.random.alpha({ count: 5,
				casing: 'upper', },) + (' (Product Pack)'), },
		...
		store: { adminStore: String(process.env.ADMIN) + 'store',
			vendorStore1: String(process.env.VENDOR) + 'store', },

		attribute: { size: { attributeName: 'size',
		...
		randomAttribute: ()=> {
			return { attributeName: 'attribute_' + faker.random.alpha(5),
		...
		variable: { productType: 'variable',
			...
			attribute: 'sizes',
			attributeTerms: ['s', 'l', 'm'],
			variations: { linkAllVariation: 'link_all_variations',
		...
		simpleSubscription: { productType: 'subscription',
		...
		variableSubscription: { productType: 'variable-subscription',
		...
		vendorSubscription: { productType: 'product_pack',
			productName: ()=> 'Dokan Subscription ' + faker.helpers.arrayElement(['Gold', 'Silver', 'Platinum', 'Premium'],) + ' ' + faker.random.alpha({ count: 5,
				casing: 'upper', },) + (' (Product Pack)'),
			category: 'Uncategorized',
			regularPrice: ()=> (faker.finance.amount(100, 200, faker.helpers.arrayElement([1, 2]))).replace('.', ','),
			numberOfProducts: '-1',
		...
		booking: { productName: ()=> faker.commerce.productName() + (' (Booking)'),
			productType: 'booking',
			category: 'Uncategorized',
			...
			blockCost: '10',
			storeName: String(process.env.VENDOR) + 'store', },
		auction: { productName: ()=> faker.commerce.productName() + (' (Auction)'),
			productType: 'auction',
			category: 'Uncategorized',
			itemCondition: 'new',
			auctionType: 'normal',
		...
		// Review
		review: { rating: faker.datatype.number({ min: 1, max: 5 }),
		...
		// Enquiry
		enquiry: { enquiryDetails: 'enquiry details',
			enquirySubmitSuccessMessage: 'Email sent successfully!', }, },

	store: { rating: faker.helpers.arrayElement(['width: 20%', 'width: 40%', 'width: 60%', 'width: 80%', 'width: 100%']),
		reviewTitle: 'store review title',
		reviewMessage: ()=> faker.datatype.uuid(), },

	order: { orderStatus: { pending: 'wc-pending',
	...
	card: { strip: { striptNon3D: '4242424242424242',
		...
		expiryDate: '1250',
		cvc: '111', },
	mangopay: { creditCard: '4972485830400049',
		expiryMonth: '12',
		expiryYear: '50',
		cvc: '111', }, },

	paymentDetails: { stripExpress: { paymentMethod: 'card',
		cardInfo: { cardNumber: '4242424242424242',
			expiryMonth: '12',
			expiryYear: '50',
	...
	wpSettings: { saveSuccessMessage: 'Your settings have been saved.',
		general: { timezone: 'UTC+6',
			saveSuccessMessage: 'Settings saved.', },
		permalink: { customBaseInput: '/product/',
	...
	shipping: { enableShipping: 'Ship to all countries you sell to',
		disableShipping: 'Disable shipping & shipping calculations',
		shippingZone: 'US',
		shippingMethods: { flatRate: { shippingZone: 'US',
	...
	payment: { saveSuccessMessage: 'Your settings have been saved.',
		currency: { dollar: 'United States (US) dollar ($)',
			euro: 'Euro (€)',
			rupee: 'Indian rupee (₹)',
			currencyOptions: { thousandSeparator: ',',
				...
				numberOfDecimals: '2', },
			saveSuccessMessage: 'Your settings have been saved.', },
		basicPayment: { toggleEanbledClass: 'woocommerce-input-toggle--enabled',
			toggleDisabledClass: 'woocommerce-input-toggle--disabled', },
		stripeConnect: { title: 'Dokan Credit card (Stripe)',
			...
			testClientId: 'ca_', },
		paypalMarketPlace: { title: 'PayPal Marketplace',
		...
		razorPay: { title: 'Razorpay',
			...
			disbursementMode: 'Delayed',
			announcementInterval: '7', },
		stripeExpress: { title: 'Dokan Express Payment Methods',
			description: 'Pay with your credit card via Stripe.',
			testPublishableKey: 'pk_test_',
			testSecretKey: 'sk_test_',
			...
			paymentRequestButtonLocation: { product: 'Product',
				cart: 'Cart', },
			announcementInterval: '7,', }, },

	dokanSettings: { general: { vendorStoreUrl: 'store',
		sellingProductTypes: 'sell_both',
		storeProductPerPage: '12',
		storCategory: 'none',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	selling: { commissionType: 'percentage',
		adminCommission: '10',
		...
		saveSuccessMessage: 'Setting has been saved successfully.', },
	withdraw: { customMethodName: 'Bksh',
		...
		saveSuccessMessage: 'Setting has been saved successfully.', },
	reverseWithdraw: { billingType: 'by_amount', // 'by_month'
		reverseBalanceThreshold: '21',
		gracePeriod: '7',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	page: { termsAndConditionsPage: 'Sample Page',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	appearance: { googleMapApiKey: String(process.env.GMAP),
		mapBoxApiKey: String(process.env.MAPBOX_API_KEY),
		storeBannerWidth: '625',
		storeBannerHeight: '300',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	privacyPolicy: { privacyPage: '2',
		...
		saveSuccessMessage: 'Setting has been saved successfully.', },
	storeSupport: { displayOnSingleProductPage: 'above_tab',
		supportButtonLabel: 'Get Support',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	rma: { orderStatus: 'wc-processing',
		rmaReasons: ['Defective', 'Wrong Product', 'Other'],
		refundPolicyHtmlBody: 'Refund Policy',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	wholesale: { whoCanSeeWholesalePrice: 'all_user',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	euCompliance: { saveSuccessMessage: 'Setting has been saved successfully.', },
	deliveryTime: { deliveryDateLabel: 'Delivery Date',
		...
		orderPerSlot: '90',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	productAdvertising: { noOfAvailableSlot: '100',
		expireAfterDays: '10',
		advertisementCost: '15',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	geolocation: { locationMapPosition: 'top',
		showMap: 'all',
		radiusSearchUnit: 'km',
		...
		saveSuccessMessage: 'Setting has been saved successfully.', },
	productReportAbuse: { reasonsForAbuseReport: 'This product is fake',
		saveSuccessMessage: 'Setting has been saved successfully.', },
	spmv: { sellItemButtonText: 'Sell This Item',
		...
		saveSuccessMessage: 'Setting has been saved successfully.', },
	vendorSubscription: { displayPage: '2',
		noOfDays: '2',
		productStatus: 'draft',
	...
	vendorSetupWizard: { choice: false,
	...
	subUrls: { backend: { login: 'wp-login.php',
		adminLogin: 'wp-admin',
	...
	admin: { username: String(process.env.ADMIN),
		password: String(process.env.ADMIN_PASSWORD), },

	vendor: { username: String(process.env.VENDOR),
		password: String(process.env.VENDOR_PASSWORD),

		vendorInfo: { email: ()=> faker.internet.email(),
			...
			openingClosingTime: { days: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'],
				openingTime: '06:00 am',
				closingTime: '12:00 pm',
				storeOpenNotice: 'Store is open',
				storeCloseNotice: 'Store is closed', },

			vacation: { instantly: { closingStyle: 'instantly',
				vacationMessage: 'We are currently out of order', },
			datewise: { vacationDayFrom: ()=> helpers.addDays(helpers.currentDate, helpers.getRandomArbitraryInteger(31, 100)),
				vacationDayTo: (from: string)=> helpers.addDays(from, 31),
				closingStyle: 'datewise',
				vacationMessage: 'We are currently out of order', } },
			discount: { minimumOrderAmount: '200',
				minimumOrderAmountPercentage: '10', },
			minMax: { minimumProductQuantity: '1',
		...
		shipping: { shippingPolicy: { processingTime: '3',
		...
		payment: { email: ()=> faker.internet.email(),
			bankAccountName: 'accountName',
			bankAccountType: faker.helpers.arrayElement(['personal', 'business']),
			bankAccountNumber: faker.random.alphaNumeric(10),
			bankName: 'bankName',
		...
		deliveryTime: { deliveryBlockedBuffer: '0',
			days: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'],
			openingTime: '06:00 am',
			closingTime: '11:30 pm',
			fullDay: 'Full day',
		...
		socialProfileUrls: { facebook: 'https://www.facebook.com/',
	...
	customer: { username: String(process.env.CUSTOMER),
		...
		customerInfo: {
			...
			getSupport: { subject: 'get Support Subject',
				message: 'get Support Message',
				supportSubmitSuccessMessage: 'Thank you. Your ticket has been submitted!', }, },
		rma: { sendMessage: 'Message send successfully', },
		account: { updateSuccessMessage: 'Account details changed successfully.', },
	...
	wholesale: { wholesaleRequestSendMessage: 'Your wholesale customer request send to the admin. Please wait for approval',
	...
	predefined: { simpleProduct: { product1: { name: 'p1_v1 (simple)',
		productName: ()=> 'p1_v1 (simple)', },
	product2: 'p2_v1 (simple)',
	productFrac1: 'p1_F1_v1 (simple)',
	productFrac2: 'p2_F2_v1 (simple)', },

	variableProduct: { product1: 'p1_v1 (variable)', },

	simpleSubscription: { product1: 'p1_v1 (simple subscription)', },

	variableSubscription: { product1: 'p1_v1 (variable subscription)', },

	externalProduct: { product1: 'p1_v1 (external/affiliate)', },

	auctionProduct: { product1: 'p1_v1 (auction)', },

	bookingProduct: { product1: 'p1_v1 (booking)', },

	saleProduct: { product1: 'p1_v1 (sale)', },

	vendorSubscription: { nonRecurring: 'Dokan_Subscription_Non_recurring', },

	coupon: { couponCode: 'c1_v1', },
	vendorInfo: { firstName: ()=> 'vendor1',
		lastName: ()=> 'v1',
		username: 'vendor1',
		shopName: String(process.env.VENDOR) + 'store', },

	vendorStores: { followFromShopPage: 'shopPage',
		followFromStorePage: 'storePage',
		vendor1: String(process.env.VENDOR) + 'store',
		shopUrl: String(process.env.VENDOR) + 'store', },
	customerInfo: { firstName: ()=> 'customer1',
		lastName: ()=> 'c1',
		username: ()=> 'customer1', }, }, };
