...
//             I.checkError();
//             I.click({css:'tr:nth-child(1) .code span'});
//             I.checkError();
//         I.click('Reports');
...
//                 I.checkError();
//             I.click({css:'tr:nth-child(1) > .details > a:nth-child(1)'});
//                 I.checkError();
//         I.click('Staff');
...
//             I.checkError();
//                 I.click({css:'tr:nth-child(1) p > a'});
//                 I.checkError();
//                 I.click('Manage Bookings');
//                     I.checkError();
//                     I.click({css:'.dokan_tabs > li:nth-child(2) > a'});
//                         I.checkError();
//                     I.amOnPage('/dashboard/booking/my-bookings/?booking_status=unpaid/');
//                         I.checkError();
//                 I.click('Calendar');
//                     I.checkError();
//                 I.click('Manage Resources');
//                     I.checkError();
//         I.click('Tools');
//             I.waitForElement('.tabs_container');
//             I.checkError();
// 				I.click('Export');
//                // I.waitForElement('#post-5');
//                 I.checkError();
// 		I.click('.support');
//             I.waitForElement('.dokan-support-topics-list');
//             I.checkError();
//                 I.click({css :'.support > a'});
//                 I.checkError();
