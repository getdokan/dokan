...
// tests
    public function indiviualAddon(\Step\Acceptance\Login $I, \Page\Acceptance\AccountPage $vendor,
     ...
     // $I->click('//table[@id="dokan-product-list-table"]/tbody/tr/td[3]/p/a');
       $CustomerView = $I->haveFriend('CustomerView');
        $CustomerView->does(function(AcceptanceTester $I){
            ...
            $I->checkOption('//form/div/p','SAusage (+£10.00)');
            $I->wait(3);
       ...
       $CustomerView->leave();
    // // tests
    // public function indiviualAddon(\Step\Acceptance\MultiSteps $I, \Page\Acceptance\AccountPage $vendor,
    //                               \Page\Acceptance\ProductPage $product)
