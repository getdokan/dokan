...
export class ProductsPage extends AdminPage {
    ...
    async addCategory(categoryName: string) {
        ...
        await this.clickAndWaitForResponse(
            data.subUrls.ajax,
            selector.admin.products.category.addNewCategory,
        );
        await this.toBeVisible(
            selector.admin.products.category.categoryCell(categoryName),
        );
    }
    ...
    async addAttribute(attribute: product['attribute']) {
        ...
        await this.fill(
            selector.admin.products.attribute.name,
            attribute.attributeName,
        );
        await this.fill(
            selector.admin.products.attribute.slug,
            attribute.attributeName,
        );
        await this.clickAndWaitForResponse(
            data.subUrls.backend.wc.addNewAttributes,
            selector.admin.products.attribute.addAttribute,
        );
        await this.toBeVisible(
            selector.admin.products.attribute.attributeCell(
                attribute.attributeName,
            ),
        );
        await this.clickAndWaitForResponse(
            data.subUrls.backend.wc.taxonomy,
            selector.admin.products.attribute.configureTerms(
                attribute.attributeName,
            ),
        );
        ...
        for (const attributeTerm of attribute.attributeTerms) {
            ...
            await this.clickAndWaitForResponse(
                data.subUrls.ajax,
                selector.admin.products.attribute.addAttributeTerm,
            );
            await this.toBeVisible(
                selector.admin.products.attribute.attributeTermCell(
                    attributeTerm,
                ),
            );
        }
    ...
    async addSimpleProduct(product: product['simple']) {
        ...
        // product basic info
        await this.type(
            selector.admin.products.product.productName,
            product.productName(),
        );
        await this.selectByValue(
            selector.admin.products.product.productType,
            product.productType,
        );
        await this.click(selector.admin.products.product.general);
        await this.type(
            selector.admin.products.product.regularPrice,
            product.regularPrice(),
        );
        await this.click(
            selector.admin.products.product.category(product.category),
        );
        ...
        if (product.stockStatus) {
            ...
            await this.selectByValue(
                selector.admin.products.product.stockStatus,
                data.product.stockStatus.outOfStock,
            );
        }

        // vendor Store Name
        await this.select2ByText(
            selector.admin.products.product.storeName,
            selector.admin.products.product.storeNameInput,
            product.storeName,
        );
        ...
        switch (product.status) {
            case 'publish':
                ...
                await this.toContainText(
                    ...
                    data.product.publishSuccessMessage,
                );
                break;
            ...
            case 'draft':
                await this.clickAndWaitForResponseAndLoadState(
                    data.subUrls.post,
                    selector.admin.products.product.saveDraft,
                    302,
                );
                await this.toContainText(
                    selector.admin.products.product.updatedSuccessMessage,
                    data.product.draftUpdateSuccessMessage,
                );
                break;
            ...
            case 'pending':
                ...
                await this.selectByValue(
                    selector.admin.products.product.status,
                ...
                await this.toContainText(
                    selector.admin.products.product.updatedSuccessMessage,
                    data.product.pendingProductUpdateSuccessMessage,
                );
                break;
    ...
    async addVariableProduct(product: product['variable']) {
        ...
        if (
            await this.isVisibleLocator(
                selector.admin.products.product.customProductAttribute,
            )
        ) {
            await this.selectByValue(
                selector.admin.products.product.customProductAttribute,
                `pa_${product.attribute}`,
            );
            await this.click(selector.admin.products.product.addAttribute);
        } else {
            await this.clickAndWaitForResponse(
                data.subUrls.backend.wc.searchAttribute,
                selector.admin.products.product.addExistingAttribute,
            );
            await this.typeAndWaitForResponse(
                data.subUrls.backend.wc.term,
                selector.admin.products.product.addExistingAttributeInput,
                product.attribute,
            );
        ...
        await this.clickAndWaitForResponse(
            data.subUrls.backend.wc.taxonomyTerms,
            selector.admin.products.product.selectAll,
        );
        await this.check(selector.admin.products.product.usedForVariations);
        await this.clickAndWaitForResponse(
            data.subUrls.ajax,
            selector.admin.products.product.saveAttributes,
        );
        ...
        await this.clickAndAcceptAndWaitForResponse(
            data.subUrls.ajax,
            selector.admin.products.product.generateVariations,
        );
        this.fillAlert('100');
        await this.selectByValue(
            selector.admin.products.product.addVariations,
            product.variations.variableRegularPrice,
        );
    ...
    async addSimpleSubscription(product: product['simpleSubscription']) {
        ...
        await this.click(selector.admin.products.product.general);
        await this.type(
            selector.admin.products.product.subscriptionPrice,
            product.subscriptionPrice(),
        );
        await this.selectByValue(
            selector.admin.products.product.subscriptionPeriodInterval,
            product.subscriptionPeriodInterval,
        );
        await this.selectByValue(
            selector.admin.products.product.subscriptionPeriod,
            product.subscriptionPeriod,
        );
        await this.selectByValue(
            selector.admin.products.product.expireAfter,
            product.expireAfter,
        );
        await this.type(
            selector.admin.products.product.subscriptionTrialLength,
            product.subscriptionTrialLength,
        );
        await this.selectByValue(
            selector.admin.products.product.subscriptionTrialPeriod,
            product.subscriptionTrialPeriod,
        );
    ...
    async addExternalProduct(product: product['external']) {
        ...
        await this.click(selector.admin.products.product.general);
        await this.type(
            selector.admin.products.product.productUrl,
            this.getBaseUrl() + product.productUrl,
        );
        await this.type(
            selector.admin.products.product.buttonText,
            product.buttonText,
        );
        await this.type(
            selector.admin.products.product.regularPrice,
    ...
    async addDokanSubscription(product: product['vendorSubscription']) {
        ...
        await this.type(
            selector.admin.products.product.numberOfProducts,
            product.numberOfProducts,
        );
        await this.type(
            selector.admin.products.product.packValidity,
            product.packValidity,
        );
        await this.type(
            selector.admin.products.product.advertisementSlot,
            product.advertisementSlot,
        );
        await this.type(
            selector.admin.products.product.expireAfterDays,
            product.expireAfterDays,
        );
    ...
    async vendorProductsRenderProperly(): Promise<void> {
        ...
        const { draft, pendingReview, ...menus } =
            selector.vendor.product.menus;
        ...
        DOKAN_PRO &&
            (await this.multipleElementVisible(
                selector.vendor.product.importExport,
            ));
        ...
        const { productAdvertisementColumn, ...table } =
            selector.vendor.product.table;
    ...
    async addProduct(
        ...
        await this.waitForVisibleLocator(
            selector.vendor.product.create.productName,
        );
        ...
        await this.clearAndType(
            selector.vendor.product.create.productPrice,
            product.regularPrice(),
        );
        // await this.addProductCategory(product.category);
        await this.clickAndWaitForResponseAndLoadState(
            data.subUrls.ajax,
            selector.vendor.product.create.createProduct,
        );
        const createdProduct = await this.getElementValue(
        ...
        await this.clearAndType(
            selector.vendor.product.edit.price,
            product.regularPrice(),
        );
        // await this.addProductCategory(product.category);
    }
    ...
    async vendorAddVariableProduct(
        ...
        // edit product
        await this.selectByValue(
            selector.vendor.product.edit.productType,
            product.productType,
        );
        // add variation
        await this.selectByValue(
            selector.vendor.product.attribute.customProductAttribute,
            `pa_${product.attribute}`,
        );
        ...
        await this.selectByValue(
            selector.vendor.product.attribute.addVariations,
            product.variations.linkAllVariation,
        );
        ...
        await this.click(selector.vendor.product.attribute.go);
        await this.type(
            selector.vendor.product.attribute.variationPrice,
            product.regularPrice(),
        );
        await this.click(selector.vendor.product.attribute.okVariationPrice);
        await this.clickAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.saveProduct,
            302,
        );
        await this.toContainText(
            selector.vendor.product.updatedSuccessMessage,
            product.saveSuccessMessage,
        );
    }

    // vendor add simple subscription product
    async vendorAddSimpleSubscription(
        product: product['simpleSubscription'],
    ): Promise<void> {
        await this.vendorAddSimpleProduct(product);
        // edit product
        await this.selectByValue(
        ...
        await this.type(
            selector.vendor.product.edit.subscriptionPrice,
            product.subscriptionPrice(),
        );
        await this.selectByValue(
            selector.vendor.product.edit.subscriptionPeriodInterval,
            product.subscriptionPeriodInterval,
        );
        await this.selectByValue(
            selector.vendor.product.edit.subscriptionPeriod,
            product.subscriptionPeriod,
        );
        await this.selectByValue(
            selector.vendor.product.edit.expireAfter,
            product.expireAfter,
        );
        await this.type(
            selector.vendor.product.edit.subscriptionTrialLength,
            product.subscriptionTrialLength,
        );
        await this.selectByValue(
            selector.vendor.product.edit.subscriptionTrialPeriod,
            product.subscriptionTrialPeriod,
        );
        await this.clickAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
    ...
    async vendorAddVariableSubscription(
        product: product['variableSubscription'],
    ): Promise<void> {
        await this.vendorAddSimpleProduct(product);
        // edit product
        await this.selectByValue(
    ...
    async vendorAddExternalProduct(
        ...
        await this.type(
            selector.vendor.product.edit.productUrl,
            this.getBaseUrl() + product.productUrl,
        );
        await this.type(
            selector.vendor.product.edit.buttonText,
            product.buttonText,
        );
        await this.clearAndType(
            selector.vendor.product.edit.price,
    ...
    async goToProductEdit(productName: string): Promise<void> {
        ...
        await this.clickAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.editProduct(productName),
        );
    ...
    async addProductCategory(category: string): Promise<void> {
        const productPopup = await this.isVisible(
            selector.vendor.product.create.productPopup,
        );
        productPopup
            ? await this.click(
                  selector.vendor.product.category
                      .productCategoryModalOnProductPopup,
              )
            : await this.click(
                  selector.vendor.product.category.productCategoryModal,
              );
        await this.waitForVisibleLocator(
            selector.vendor.product.category.productCategorySearchInput,
        );
        await this.type(
            selector.vendor.product.category.productCategorySearchInput,
            category,
        ...
        await this.toContainText(
            selector.vendor.product.category.searchedResultText,
            category,
        );
        await this.click(
            selector.vendor.product.category.productCategorySearchResult,
        );
        await this.click(selector.vendor.product.category.productCategoryDone);

        const categoryAlreadySelectedPopup = await this.isVisible(
            selector.vendor.product.category
                .productCategoryAlreadySelectedPopup,
        );
        if (categoryAlreadySelectedPopup) {
            ...
            await this.click(
                selector.vendor.product.category.productCategoryModalClose,
            );
        }
    ...
    async vendorAddProductCategory(
        productName: string,
        category: string,
    ): Promise<void> {
    ...
    async exportProducts(): Promise<void> {
        ...
        await this.clickAndWaitForLoadState(
            selector.vendor.product.importExport.export,
        );
    ...
    async searchProduct(productName: string): Promise<void> {
        ...
        await this.clearAndType(
            selector.vendor.product.search.searchInput,
            productName,
        );
        await this.clickAndWaitForResponse(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.search.searchBtn,
        );
        await this.toBeVisible(
            selector.vendor.product.productLink(productName),
        );
    }
    ...
    async filterProducts(filterBy: string, value: string): Promise<void> {
        ...
        switch (filterBy) {
            case 'by-date':
                await this.selectByNumber(
                    selector.vendor.product.filters.filterByDate,
                    value,
                );
                break;
            ...
            case 'by-category':
                await this.selectByLabel(
                    selector.vendor.product.filters.filterByCategory,
                    value,
                );
                break;
            ...
            case 'by-type':
                await this.selectByValue(
                    selector.vendor.product.filters.filterByType,
                    value,
                );
                break;
            ...
            case 'by-other':
                await this.selectByValue(
                    selector.vendor.product.filters.filterByOther,
                    value,
                );
                break;
        ...
        await this.clickAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.filters.filter,
        );
    ...
    async viewProduct(productName: string): Promise<void> {
        ...
        await this.hover(selector.vendor.product.productCell(productName));
        await this.clickAndWaitForLoadState(
            selector.vendor.product.view(productName),
        );
        await expect(this.page).toHaveURL(
            data.subUrls.frontend.productDetails(helpers.slugify(productName)) +
                '/',
        );
        const { quantity, addToCart, viewCart, ...productDetails } =
            selector.customer.cSingleProduct.productDetails;
    ...
    async editProduct(product: product['simple']): Promise<void> {
        ...
        await this.clearAndType(
            selector.vendor.product.edit.title,
            product.editProduct,
        ); // don't update name below test needs same product
        await this.clearAndType(
            selector.vendor.product.edit.price,
            product.regularPrice(),
        );
        ...
        await this.toContainText(
            selector.vendor.product.dokanMessage,
    ...
    async addProductQuantityDiscount(
        productName: string,
        quantityDiscount: vendor['vendorInfo']['quantityDiscount'],
    ): Promise<void> {
        await this.goToProductEdit(productName);
        await this.check(selector.vendor.product.discount.enableBulkDiscount); // todo: need to fix
        await this.clearAndType(
            selector.vendor.product.discount.lotMinimumQuantity,
            quantityDiscount.minimumQuantity,
        );
        await this.clearAndType(
            selector.vendor.product.discount.lotDiscountInPercentage,
        ...
        await this.toContainText(
            selector.vendor.product.updatedSuccessMessage,
            data.product.createUpdateSaveSuccessMessage,
        );
    }

    // vendor add product rma settings
    async addProductRmaSettings(
        productName: string,
        rma: vendor['rma'],
    ): Promise<void> {
        await this.goToProductEdit(productName);
        await this.check(
            selector.vendor.product.rma
        ...
        await this.selectByValue(
            selector.vendor.product.rma.length,
            rma.rmaLength,
        );
        // todo: add rma as addon
        if (rma.rmaLength === 'limited') {
            await this.clearAndType(
                selector.vendor.product.rma.lengthValue,
                rma.lengthValue,
            );
            await this.selectByValue(
                selector.vendor.product.rma.lengthDuration,
                rma.lengthDuration,
            );
        }
        const refundReasonIsVisible = await this.isVisible(
            selector.vendor.product.rma.refundReasonsFirst,
        );
    ...
    async quickEditProduct(product: product['simple']): Promise<void> {
        ...
        await this.hover(
            selector.vendor.product.productCell(product.editProduct),
        );
        await this.click(
            selector.vendor.product.quickEdit(product.editProduct),
        );

        await this.clearAndType(
            selector.vendor.product.quickEditProduct.title,
            product.editProduct,
        );
        // todo:  add more fields
        ...
        await this.clickAndWaitForResponse(
            data.subUrls.ajax,
            selector.vendor.product.quickEditProduct.update,
        );
    }
    ...
    async duplicateProduct(productName: string): Promise<void> {
        ...
        await this.clickAndAcceptAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.duplicate(productName),
        );
        await this.toContainText(
            selector.vendor.product.dokanSuccessMessage,
            'Product succesfully duplicated',
        );
    }
    ...
    async permanentlyDeleteProduct(productName: string): Promise<void> {
        ...
        await this.hover(selector.vendor.product.productCell(productName));
        await this.click(
            selector.vendor.product.permanentlyDelete(productName),
        );
        await this.clickAndWaitForLoadState(
            selector.vendor.product.confirmAction,
        );
        await this.toContainText(
            selector.vendor.product.dokanSuccessMessage,
    ...
    async productBulkAction(
        ...
        switch (action) {
            case 'edit':
                await this.selectByValue(
                    selector.vendor.product.bulkActions.selectAction,
                    'edit',
                );
                // todo:
                break;
        ...
        await this.clickAndAcceptAndWaitForResponseAndLoadState(
            data.subUrls.frontend.vDashboard.products,
            selector.vendor.product.bulkActions.applyAction,
        );
    }
}
