...
export class VendorReportsPage extends VendorPage {
    ...
    async vendorReportsRenderProperly(): Promise<void> {
        ...
        await this.clickAndWaitForLoadState(
            selector.vendor.vReports.menus.salesByDay,
        );
        ...
        await this.clickAndWaitForLoadState(
            selector.vendor.vReports.menus.topSelling,
        );
        ...
        await this.multipleElementVisible(
            selector.vendor.vReports.topSelling.table,
        );

        await this.clickAndWaitForLoadState(
            selector.vendor.vReports.menus.topEarning,
        );
        ...
        await this.multipleElementVisible(
            selector.vendor.vReports.topEarning.table,
        );

        await this.clickAndWaitForLoadState(
            selector.vendor.vReports.menus.statement,
        );
        ...
        await this.multipleElementVisible(
            selector.vendor.vReports.statement.table,
        );

        // export statements button is visible
        await this.toBeVisible(
            selector.vendor.vReports.statement.exportStatements,
        );
    }
    ...
    async exportStatement(): Promise<void> {
        ...
        const isDisabled = await this.hasAttribute(
            selector.vendor.vReports.statement.exportStatements,
            'disabled',
        );
        !isDisabled &&
