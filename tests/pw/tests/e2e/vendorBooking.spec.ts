...
test.describe('Booking Product test', () => {
    ...
    test('vendor booking menu page is rendering properly', { tag: ['@pro', '@exp', '@vendor'] }, async () => {
        await vendor.vendorBookingRenderProperly();
    });

    test('vendor manage booking page is rendering properly', { tag: ['@pro', '@exp', '@vendor'] }, async () => {
        await vendor.vendorManageBookingRenderProperly();
    });

    test('vendor booking calendar page is rendering properly', { tag: ['@pro', '@exp', '@vendor'] }, async () => {
        await vendor.vendorBookingCalendarRenderProperly();
    });

    test('vendor manage booking resource page is rendering properly', { tag: ['@pro', '@exp', '@vendor'] }, async () => {
