...
test.describe('Follow stores functionality test', () => {
    ...
    test('customer followed vendors menu page is rendering properly', { tag: ['@pro', '@exp', '@customer'] }, async () => {
    ...
    test('vendor followers menu page is rendering properly', { tag: ['@pro', '@exp', '@vendor'] }, async () => {
