...
export const required = parseBoolean(process.env.PAYPAL_MARKETPLACE_REQUIRED);

export const merchantWarning =
...
export class PayPalMarketplacePreflightPage {
    async ppPre01(): Promise<void> {
