...
test.describe.only('Settings test', () => {
    ...
    test.skip('admin can set vendor store url (general settings) @lite', async () => {
    ...
    test('admin can set vendor setup wizard logo & message (general settings) @lite', async () => {
    ...
    test('admin can disable vendor setup wizard (general settings) @lite', async () => {
    ...
    test('admin can set store terms and conditions (general settings) @lite', async () => {
    ...
    test('admin can set store products per page (general settings) @lite', async () => {
    ...
    test('admin can enable address fields on registration (general settings) @lite', async () => {
    ...
    test('admin can enable store terms and conditions on registration (general settings) @pro', async () => {
    ...
    test('admin can set show vendor info (general settings) @lite', async () => {
    ...
    test('admin can enable more products tab (general settings) @lite', async () => {
    ...
    test('admin can enable vendor selling (selling settings) @lite', async () => {
    ...
    test('admin can set order status change capability (selling settings) @lite', async () => {
        apiUtils = new ApiUtils(await request.newContext());
