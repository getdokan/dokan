    ...
    test.describe(`product api test ${version}`, () => {
        test('get products summary @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getProductsSummary.replace('v1', version),
            );
        ...
        test('get top rated products @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getTopRatedProducts.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get best selling products @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getBestSellingProducts.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get featured products @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getFeaturedProducts.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get latest products @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getLatestProducts.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get all multiStep categories @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getAllMultiStepCategories.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get all products @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getAllProducts.replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('get single product @lite', async () => {
            const [response, responseBody] = await apiUtils.get(
                endPoints.getSingleProduct(productId).replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
        ...
        test('create a product @lite', async () => {
            const [response, responseBody] = await apiUtils.post(
                endPoints.createProduct.replace('v1', version),
        ...
        test('update a product @lite', async () => {
            const [response, responseBody] = await apiUtils.put(
                endPoints.updateProduct(productId).replace('v1', version),
        ...
        test('delete a product @lite', async () => {
            const [response, responseBody] = await apiUtils.delete(
                endPoints.deleteProduct(productId).replace('v1', version),
            );
            expect(response.ok()).toBeTruthy();
            expect(responseBody).toBeTruthy();
        });
