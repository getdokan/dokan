...
test.describe('new settings api test', () => {
    ...
    test('get single setting group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.get(
            endPoints.getSingleSettingGroup('store'),
        );
        expect(response.ok()).toBeTruthy();
        expect(responseBody).toBeTruthy();
    });
    ...
    test('update single setting group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.post(
            endPoints.updateSingleSettingGroup('store'),
    ...
    test('get sub settings from single settings group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.get(
            endPoints.getSubSettingFromSingleSettingGroup(
                'store',
                'store_name',
            ),
        );
    ...
    test('update sub settings from single settings group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.post(
            endPoints.updateSubSettingFromSingleSettingGroup(
                'store',
                'store_name',
            ),
    ...
    test('get sub sub settings from single settings group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.get(
            endPoints.getSubSubSettingFromSingleSettingGroup(
                'store',
                'address',
                'street_1',
            ),
    ...
    test('update sub sub settings from single settings group @v2 @lite', async () => {
        const [response, responseBody] = await apiUtils.post(
            endPoints.updateSubSubSettingFromSingleSettingGroup(
                'store',
                'address',
                'street_1',
            ),
