    ...
    adminSettingsMigration: {
        ...
        selectors: {
            oldUI: {
                ...
                vendorsCanCreateTagsField: '.product_vendors_can_create_tags .switch',
                addNewAttributeValuesField: '.add_new_attribute .switch',
                productReviewManagementField: '.seller_review_manage .switch',
