...
export const data = {
    ...
    adminSettingsMigration: {
        urls: {
            legacyAdminSettings: 'wp-admin/admin.php?page=dokan#/settings',
        ...
        testData: {
            storeUrlSlugs: ['store-alpha', 'store-beta'],
            wizardMessages: ['Congratulations! Your marketplace is ready.', 'Welcome to the new Dokan dashboard!'],
            logo: 'utils/assets/dokan_logo.png',
        },
    },
