...
const addList = core => {
    ...
    core.summary.clear();
    return core.summary.addList([envInfo.os, envInfo.wpVersion, envInfo.phpVersion, envInfo.mysqlVersion, String(envInfo.wpDebugMode), envInfo.theme, pluginDetails]).stringify();
};
