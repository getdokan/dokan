<tr>
    ...
    <td>
        <p>
            ...
            <a href="#" class="dokan-btn dokan-btn-sm dokan-btn-default upload_file_button" data-choose="<?php esc_attr_e( 'Choose file', 'dokan-lite' ); ?>" data-update="<?php esc_attr_e( 'Insert file URL', 'dokan-lite' ); ?>"><?php echo str_replace( ' ', '&nbsp;', esc_html__( 'Choose file', 'dokan-lite' ) ); ?></a>
        </p>
    </td>
