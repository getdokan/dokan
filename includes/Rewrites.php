...
class Rewrites {
    ...
    public function store_query_filter( $query ) {
        ...
        if ( ! is_admin() && $query->is_main_query() && ! empty( $author ) ) {
            ...
            $product_ppp   = dokan_get_option( 'store_product_per_page', 'dokan_general', 12 );
            ...
            set_query_var( 'posts_per_page', apply_filters( 'dokan_store_product_per_page', $post_per_page ) );
