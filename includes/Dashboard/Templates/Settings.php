    ...
    function insert_settings_info() {
        ...
        if ( wp_verify_nonce( sanitize_key( $post_data['_wpnonce'] ), 'dokan_profile_settings_nonce' ) ) {
            ...
            $dokan_settings = array(
                ...
                'show_featured_products'   => sanitize_text_field( $post_data['setting_show_featured_products'] ),
                'show_latest_products'     => sanitize_text_field( $post_data['setting_show_latest_products'] ),
                'show_best_sell_products'  => sanitize_text_field( $post_data['setting_show_best_sell_products'] ),
                'show_top_rated_products'  => sanitize_text_field( $post_data['setting_show_top_rated_products'] ),
