    ...
    function insert_settings_info() {
        ...
        if ( wp_verify_nonce( sanitize_key( $post_data['_wpnonce'] ), 'dokan_profile_settings_nonce' ) ) {
            ...
            $dokan_settings = array(
                ...
                'hide_featured_products'   => isset( $post_data['setting_hide_featured_products'] ) ? sanitize_text_field( $post_data['setting_hide_featured_products'] ) : 'no',
                'hide_latest_products'     => isset( $post_data['setting_hide_latest_products'] ) ? sanitize_text_field( $post_data['setting_hide_latest_products'] ) : 'no',
                'hide_best_sell_products'  => isset( $post_data['setting_hide_best_sell_products'] ) ? sanitize_text_field( $post_data['setting_hide_best_sell_products'] ) : 'no',
                'hide_top_rated_products'  => isset( $post_data['setting_hide_top_rated_products'] ) ? sanitize_text_field( $post_data['setting_hide_top_rated_products'] ) : 'no',
