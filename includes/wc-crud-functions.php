...
//
//add_filter( 'woocommerce_new_order_data', 'dokan_set_seller_id_on_order' );
//
//function dokan_set_seller_id_on_order( $args, $seller_order ) {
//    
//    $args[ 'post_author' ] = $seller_order->seller_id;
//    
//}