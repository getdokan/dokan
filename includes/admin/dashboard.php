    ...
    <div class="dokan-left">
        ...
        <ul>
            <li class="seller-count">
                ...
                <a href="<?php echo WeDevs_Dokan::init()->is_pro_exists() ? admin_url( 'admin.php?page=dokan-sellers' ) : ''; ?>"><?php printf( _n( __( '%d Total Vendor', 'dokan' ), __( '%d Total Vendors', 'dokan' ), $total_seller, 'dokan' ), $total_seller ); ?></a>
            </li>
    ...
    <div class="dokan-right">
        ...
        <ul>
            <li class="withdraw-pending <?php echo ($withdraw_counts['pending'] < 1) ? 'mark-green' : 'mark-red'; ?>">
                ...
                <a href="<?php echo WeDevs_Dokan::init()->is_pro_exists() ? admin_url( 'admin.php?page=dokan-withdraw' ) : ''; ?>"><?php printf( __( '%d Pending Withdraw', 'dokan' ), $withdraw_counts['pending'] ); ?></a>
            </li>
            <li class="withdraw-completed mark-green">
                <div class="dashicons dashicons-yes"></div>
                <a href="<?php echo WeDevs_Dokan::init()->is_pro_exists() ? admin_url( 'admin.php?page=dokan-withdraw&amp;status=completed' ) : ''; ?>"><?php printf( __( '%d Completed Withdraw', 'dokan' ), $withdraw_counts['completed'] ); ?></a>
            </li>
            <li class="withdraw-cancelled">
                <div class="dashicons dashicons-dismiss"></div>
                <a href="<?php echo WeDevs_Dokan::init()->is_pro_exists() ? admin_url( 'admin.php?page=dokan-withdraw&amp;status=cancelled' ) : ''; ?>"><?php printf( __( '%d Cancelled Withdraw', 'dokan' ), $withdraw_counts['cancelled'] ); ?></a>
            </li>
        </ul>
    </div>
