...
class AdminDashboardController extends DokanBaseAdminController
{
    ...
    public function register_routes()
    {
        ...
        register_rest_route(
            $this->namespace,
            '/' . $this->rest_base . '/monthly-overview',
            [
                [
                    'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route(
            $this->namespace,
            '/' . $this->rest_base . '/customer-metrics',
            [
                [
                    'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route(
            $this->namespace,
            '/' . $this->rest_base . '/top-performing-vendors',
            [
                [
                    'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route(
            $this->namespace,
            '/' . $this->rest_base . '/most-reviewed-products',
            [
                [
                    'methods'             => WP_REST_Server::READABLE,
    ...
    public function get_sales_chart_data($date = '')
    {
        ...
        $current_totals = AdminDashboardStats::get_sales_chart_data(
            $date_range['current_month_start'],
            $date_range['current_month_end']
        );
        // Previous month totals
        $previous_totals = AdminDashboardStats::get_sales_chart_data(
