    ...
    private function get_rest_api_class_map() {
        ...
        $this->class_map = apply_filters(
            'dokan_rest_api_class_map', array(
                ...
                DOKAN_DIR . '/includes/REST/DataCountryController.php'         => '\WeDevs\Dokan\REST\DataCountryController',
                DOKAN_DIR . '/includes/REST/ShippingMethodController.php'       => '\WeDevs\Dokan\REST\ShippingMethodController',
                DOKAN_DIR . '/includes/REST/ShippingStatusController.php'        => '\WeDevs\Dokan\REST\ShippingStatusController',
                DOKAN_DIR . '/includes/REST/TaxClassController.php'            => '\WeDevs\Dokan\REST\TaxClassController',
                DOKAN_DIR . '/includes/REST/TaxController.php'                 => '\WeDevs\Dokan\REST\TaxController',
                DOKAN_DIR . '/includes/REST/PaymentGatewayController.php'       => '\WeDevs\Dokan\REST\PaymentGatewayController',
                DOKAN_DIR . '/includes/REST/OrderControllerV3.php'              => '\WeDevs\Dokan\REST\OrderControllerV3',
                DOKAN_DIR . '/includes/REST/OrderNoteControllerV3.php'            => '\WeDevs\Dokan\REST\OrderNoteControllerV3',
                DOKAN_DIR . '/includes/REST/OrderRefundControllerV3.php'          => '\WeDevs\Dokan\REST\OrderRefundControllerV3',
                DOKAN_DIR . '/includes/REST/OrderActionControllerV3.php'          => '\WeDevs\Dokan\REST\OrderActionControllerV3',
            )
        );
    }
}
