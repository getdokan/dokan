...
class Installer {
    ...
    protected function create_dokan_order_stats_table() {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}dokan_order_stats` (
                ...
                `order_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = WC Order, 1 = Dokan Single Vendor Order, 2 = Dokan Suborder, 3 = Refund of WC Order, 4 = Refund of Dokan Suborder ',
