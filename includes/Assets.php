    ...
    public function conditional_localized_args( $default_args ) {
        if ( dokan_is_seller_dashboard()
            ...
            $custom_args = [
                ...
                'dokan_product_validation'            => get_option( 'dokan_product_validation', true ),
                ...
                'product_price_required'              => __( 'Product price is required', 'dokan-lite' ),
                'product_discount_required'           => __( 'Product discount is required', 'dokan-lite' ),
                'product_image_required'              => __( 'Product feature image is required', 'dokan-lite' ),
                'product_category_required'           => __( 'Product category is required', 'dokan-lite' ),
                'product_excerpt_required'            => __( 'Product short description is required', 'dokan-lite' ),
