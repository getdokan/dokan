...
class Manager {
    ...
    public function create_coupons( $order, $parent_order, $products ) {
        ...
        foreach ( $used_coupons as $item ) {
            ...
            if ( $coupon && ! is_wp_error( $coupon ) && ( array_intersect( $product_ids, $coupon->get_product_ids() ) || ( function_exists( 'dokan_is_order_have_admin_coupons_for_vendors' ) && dokan_is_order_have_admin_coupons_for_vendors( $order, $seller_id ) ) ) ) {
