...
class Customizer {
    ...
    protected function add_store_section( WP_Customize_Manager $wp_customize ) {
        $wp_customize->add_section(
            ...
            [
                ...
                // 'description'    => __( 'Customize the appearance of your vendor store page.', 'dokan-lite' ),
                'priority'       => 10,
                'panel'          => 'dokan',
            ]
        );
            ...
            new Customizer\RadioImageControl(
                ...
                [
                    ...
                    'choices'  => [
                        ...
                        'layout1'  => [
                            'label' => __( 'Default Layout', 'dokan-lite' ),
                            'src'   => DOKAN_PLUGIN_ASSEST . '/images/customizer/2cl.png',
        ...
        // if the sidebar isn't enabled, we can't turn on/off the widgets
        if ( dokan_store_theme_sidebar_enabled() ) {
            // return;
        }
        ...
        $wp_customize->add_control(
            new Customizer\HeadingControl(
                ...
                [
                    ...
                    'settings'        => [],
                    'active_callback' => [ $this, 'is_sidebar_enabled_callback' ],
                ]
            )
        );
     ...
     * @return bool
     */
    public function is_sidebar_enabled_callback( WP_Customize_Control $control ) {
