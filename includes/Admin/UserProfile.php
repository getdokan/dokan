...
class UserProfile {
    ...
    function save_meta_fields( $user_id ) {
        ...
        if ( ! isset( $post_data['dokan_update_user_profile_info_nonce'] ) || ( isset( $post_data['dokan_update_user_profile_info_nonce'] ) && ! wp_verify_nonce( $post_data['dokan_update_user_profile_info_nonce'], 'dokan_update_user_profile_info' ) ) ) {
            return;
        }
