    ...
    public function get_settings_sections() {
        $sections = [
            ...
            [
                ...
                'title'                => __( 'Product Fields Validation', 'dokan-lite' ),
                'icon_url'             => DOKAN_PLUGIN_ASSEST . '/images/admin-settings-icons/reverse-witdrawal.svg',
                'description'          => __( 'Vendor products validation control', 'dokan-lite' ),
                'document_link'        => 'https://wedevs.com/docs/dokan/withdraw/dokan-reverse-withdrawal/',
                'settings_title'       => __( 'Product Validation Settings', 'dokan-lite' ),
                'settings_description' => __( 'Configure fields validation from admin on vendors product creation and edit page.', 'dokan-lite' ),
            ],
            [
                'id'                   => 'dokan_pages',
        ...
        $dokan_product_general_validation = apply_filters(
            'dokan_product_general_validation', [
                'dokan_product_validation' => [
                    'name'  => 'dokan_product_validation',
                    'label' => __( 'General Fields', 'dokan-lite' ),
                    'type'  => 'sub_section',
                ],
                'product_title' => [
                    'name'    => 'product_title',
                    'label'   => __( 'Product Title', 'dokan-lite' ),
                    'desc'    => __( 'Make product title field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'product_price' => [
                    ...
                    'desc'    => __( 'Make product price field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'product_image' => [
                    ...
                    'desc'    => __( 'Make product image field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'product_category' => [
                    ...
                    'desc'    => __( 'Make product category field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'product_short_desc' => [
                    ...
                    'desc'    => __( 'Make product short description field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'product_long_desc' => [
                    ...
                    'desc'    => __( 'Make product long description field required.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
            ]
        ...
        $dokan_product_sections_validation = apply_filters(
            'dokan_product_sections_validation', [
                ...
                'product_downloadable_section' => [
                    ...
                    'desc'    => __( 'Hide product downloadable options section.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
                'other_options_section' => [
                    ...
                    'desc'    => __( 'Hide product other options section.', 'dokan-lite' ),
                    'type'    => 'checkbox',
                    'default' => 'off',
                ],
            ]
