...
class Settings {
    ...
    public function get_settings_fields() {
        ...
        $general_site_options = apply_filters(
            'dokan_settings_general_site_options', array(
				'site_options' => array(
					'name'  => 'site_options',
        ...
        $general_vendor_store_options = apply_filters(
            'dokan_settings_general_vendor_store_options', array(
        ...
        $selling_option_commission = apply_filters(
            'dokan_settings_selling_option_commission', array(
				'commission' => array(
					'name'  => 'commission',
        ...
        $selling_option_vendor_capability = apply_filters(
            'dokan_settings_selling_option_vendor_capability', array(
