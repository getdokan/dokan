...
class Settings {
    ...
    public function get_settings_value() {
        ...
        $new_seller_enable_selling_statuses = ( isset( $settings['dokan_selling']['new_seller_enable_selling'] ) && ! empty( $settings['dokan_selling']['new_seller_enable_selling'] ) )
        ...
        if ( ! in_array( $new_seller_enable_selling_statuses, $settings, true ) ) {
            $settings['dokan_selling']['new_seller_enable_selling'] = dokan_get_container()->get( AdminSettings::class )->get_new_seller_enable_selling_status(
                isset( $settings['dokan_selling']['new_seller_enable_selling'] ) ? $settings['dokan_selling']['new_seller_enable_selling'] : 'automatically'
            );
        }
