...
//        'dokan_withdraw.weekly_schedule'                             => 'transaction.withdraw_charge.withdraw_option_visibility_section.weekly_withdraw_sub_section.weekly_withdraw_group.weekly_withdraw_day',
        ...
        'dokan_verification.verified_icon'                           => 'verification.vendor-verification-page.verified-icons.verified_icon',

        //Verification > Email Verification
        'dokan_email_verification.enabled'                           => 'verification.email-verification-page.email-verification-content.enabled',
        'dokan_email_verification.registration_notice'               => 'verification.email-verification-page.email-verification-content.registration_notice',
        'dokan_email_verification.login_notice'                      => 'verification.email-verification-page.email-verification-content.login_notice',
