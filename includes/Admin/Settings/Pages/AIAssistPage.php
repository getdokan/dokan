...
class AIAssistPage extends AbstractPage {
    ...
    public function describe_settings(): void {
        $product_generation = ElementFactory::sub_page(
            ...
            ->add(
                ElementFactory::section( 'product_info_generation' )
                                ->add(
                                ...
                                ->add(
                                    ElementFactory::field( 'product_info_engine', 'select' )
                                                ...
                                                ->set_default( 'chatgpt' )
                                                ->add_dependency( 'product_generation.product_info_generation.product_info_generate', 'on', true, 'display', 'show', '==' )
                                                ->add_dependency( 'product_generation.product_info_generation.product_info_generate', 'on', true, 'display', 'hide', '!==' )
                                )
                                ->add(
                                    ElementFactory::field_group( 'chatgpt_api_group' )
                                                ->add_dependency( 'product_generation.product_info_generation.product_info_generate', 'on', true, 'display', 'show', '==' )
                                                ->add_dependency( 'product_generation.product_info_generation.product_info_generate', 'on', true, 'display', 'hide', '!==' )
                                                ->add(
                                                    ElementFactory::field( 'openai_api_info', 'base_field_label' )
                                                                    ...
                                                                    ->set_image_url( plugin_dir_url( DOKAN_FILE ) . 'assets/src/images/ai-assist/chat-gpt-thumbnail.svg' )
                                                )
                                                ->add(
            ...
            ->add(
                ElementFactory::section( 'product_image_enhancement' )
                                ->add(
                                ...
                                ->add(
                                    ElementFactory::field( 'product_image_engine', 'select' )
                                                ...
                                                ->add_dependency( 'product_generation.product_image_enhancement.product_image_enhancement', 'on', true, 'display', 'show', '==' )
                                                ->add_dependency( 'product_generation.product_image_enhancement.product_image_enhancement', 'on', true, 'display', 'hide', '!==' )
                                )
                                ->add(
                                    ElementFactory::field_group( 'leonardo_api_group' )
                                                ->add_dependency( 'product_generation.product_image_enhancement.product_image_enhancement', 'on', true, 'display', 'show', '==' )
                                                ->add_dependency( 'product_generation.product_image_enhancement.product_image_enhancement', 'on', true, 'display', 'hide', '!==' )
                                                ->add(
