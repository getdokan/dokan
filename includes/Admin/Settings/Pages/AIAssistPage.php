                                                    ...
                                                    ElementFactory::field( 'openai_api_info', 'base_field_label' )
                                                                    ...
                                                                    ->set_description(
                                                                        ...
                                                                        /* translators: 1. Link start tag, 2. Link end tag */
                                                                            __( 'Connect to your OpenAI account with your website. %1$sGet Help%2$s', 'dokan-lite' ),
                                                ...
                                                ->add(
                                                    ElementFactory::field( 'leonardo_api_notice', 'info' )
                                                                    ...
                                                                    ->set_description(
                                                                        sprintf(
                                                                        /* translators: 1. Link start tag, 2. Link end tag */
                                                                            __( 'Access your Leonardo AI dashboard to generate API keys for integration. %1$sGet Help%2$s', 'dokan-lite' ),
