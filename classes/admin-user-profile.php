        ...
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="dokan_store_url" vendor="<?php echo $user->ID; ?>" class="regular-text" id="seller-url" value="<?php echo esc_attr( $user->data->user_nicename ); ?>"><strong id="url-alart-mgs"></strong>
