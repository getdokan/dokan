...
class Dokan_Template_Settings {
    ...
    function validate() {
        ...
        if ( !empty( $post_data['setting_paypal_email'] ) ) {
            $email = filter_var( $post_data['setting_paypal_email'], FILTER_VALIDATE_EMAIL );
            if ( empty( $email ) ) {
    ...
    function insert_settings_info() {
        ...
        if ( wp_verify_nonce( $post_data['_wpnonce'], 'dokan_profile_settings_nonce' ) ) {
            ...
            $dokan_settings = array(
                ...
                'address'                  => isset( $post_data['dokan_address'] ) ? $post_data['dokan_address'] : $prev_dokan_settings['address'],
                ...
                'enable_tnc'               => isset( $post_data['dokan_store_tnc_enable'] ) ? $post_data['dokan_store_tnc_enable'] : '',
                'store_tnc'                => isset( $post_data['dokan_store_tnc'] ) ? $post_data['dokan_store_tnc'] : '',
                'dokan_store_time'         => array(
                    'sunday'               => array(
                        'open'             => isset( $post_data['sunday_on_off'] ) ? $post_data['sunday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['sunday_opening_time'] ) ? $post_data['sunday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['sunday_closing_time'] ) ? $post_data['sunday_closing_time'] : '',
                    ),
                    'monday'               => array(
                        'open'             => isset( $post_data['monday_on_off'] ) ? $post_data['monday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['monday_opening_time'] ) ? $post_data['monday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['monday_closing_time'] ) ? $post_data['monday_closing_time'] : '',
                    ),
                    'tuesday'              => array(
                        'open'             => isset( $post_data['tuesday_on_off'] ) ? $post_data['tuesday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['tuesday_opening_time'] ) ? $post_data['tuesday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['tuesday_closing_time'] ) ? $post_data['tuesday_closing_time'] : '',
                    ),
                    'wednesday'            => array(
                        'open'             => isset( $post_data['wednesday_on_off'] ) ? $post_data['wednesday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['wednesday_opening_time'] ) ? $post_data['wednesday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['wednesday_closing_time'] ) ? $post_data['wednesday_closing_time'] : '',
                    ),
                    'thursday'             => array(
                        'open'             => isset( $post_data['thursday_on_off'] ) ? $post_data['thursday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['thursday_opening_time'] ) ? $post_data['thursday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['thursday_closing_time'] ) ? $post_data['thursday_closing_time'] : '',
                    ),
                    'friday'               => array(
                        'open'             => isset( $post_data['friday_on_off'] ) ? $post_data['friday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['friday_opening_time'] ) ? $post_data['friday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['friday_closing_time'] ) ? $post_data['friday_closing_time'] : '',
                    ),
                    'saturday'             => array(
                        'open'             => isset( $post_data['saturday_on_off'] ) ? $post_data['saturday_on_off'] : 'close' ,
                        'opening_time'     => isset( $post_data['saturday_opening_time'] ) ? $post_data['saturday_opening_time'] : '',
                        'closing_time'     => isset( $post_data['saturday_closing_time'] ) ? $post_data['saturday_closing_time'] : '',
                    )
                ),
                'dokan_store_time_enabled' => isset( $post_data['dokan_store_time_enabled'] ) ? $post_data['dokan_store_time_enabled'] : '',
                'dokan_store_open_notice'  => isset( $post_data['dokan_store_open_notice'] ) ? $post_data['dokan_store_open_notice'] : '',
                'dokan_store_close_notice' => isset( $post_data['dokan_store_close_notice'] ) ? $post_data['dokan_store_close_notice'] : '',
            );
            ...
            if ( isset( $post_data['settings']['paypal'] ) ) {
                $dokan_settings['payment']['paypal'] = array(
                    'email' => filter_var( $post_data['settings']['paypal']['email'], FILTER_VALIDATE_EMAIL )
                );
            }

            if ( isset( $post_data['settings']['skrill'] ) ) {
                $dokan_settings['payment']['skrill'] = array(
                    'email' => filter_var( $post_data['settings']['skrill']['email'], FILTER_VALIDATE_EMAIL )
                );
            }
