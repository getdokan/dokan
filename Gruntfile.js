    ...
    less: {
      ...
      admin: {
        files: {
          ...
          '<%= dirs.css %>/admin-notice.css': ['<%= dirs.devLessSrc %>/admin-notice.less'],
    ...
    concat: {
      all_js: {
        files: {
          ...
          '<%= dirs.js %>/dokan-admin-notice.js': [
            '<%= dirs.devJsSrc %>/dokan-admin-notice.js'
          ]
        }
      },
      ...
      backend_js: {
        files: {
          '<%= dirs.js %>/dokan-admin.js': ['<%= dirs.devJsSrc %>/admin.js'],
