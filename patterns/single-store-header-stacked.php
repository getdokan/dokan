...
?>
<!-- wp:group {"metadata":{"name":"Store Header"},"align":"full","className":"dokan-single-store-header","style":{"spacing":{"blockGap":"var:preset|spacing|30","margin":{"bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull dokan-single-store-header" style="margin-bottom:var(--wp--preset--spacing--50)">
    ...
    <!-- wp:group {"metadata":{"name":"Store Details"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
