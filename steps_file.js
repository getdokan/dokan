...
module.exports = function() {
  return actor({
    ...
    loginAsAdmin: function () {
      ...
      this.fillField('#user_pass', 'ajaira@website');
      this.click('Log In');
    },
    ...
    viewSingleProduct: function () {
     // this.click({css:'.sfHover > a'});
      this.amOnPage('https://dokan.ajaira.website/shop/');
      this.amOnPage('/dokan/shop/?orderby=date');
      this.wait(5);
      this.click('/html/body/div[2]/div/div[1]/main/article/div/div/ul/li[1]/a/img');
    },
