...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_toConsumableArray__ = __webpack_require__(282);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__babel_runtime_regenerator__ = __webpack_require__(27);
...
(function ($) {
  ...
  var loader = $('#dokan-single-categories-loader');
  ...
  var ProductCategory = {
    ...
    doSearchCates: function () {
      var _doSearchCates = __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2__babel_runtime_regenerator___default.a.mark(function _callee(text) {
      ...
      function doSearchCates(_x) {
        return _doSearchCates.apply(this, arguments);
      }

      return doSearchCates;
    }(),
    ...
    loadingCategories: function loadingCategories() {
    ...
    getCatLiHtml: function getCatLiHtml(element, level) {
      ...
      element.forEach(function (category, index) {
        html += "<li data-haschild=\"".concat(category.children.length > 0, "\" data-name=\"").concat(category.name, "\" data-catLevel=\"").concat(level, "\" class=\"").concat(category.uiActivaion ? category.uiActivaion : '', " dokan-product-category-li ").concat(category.children.length > 0 ? 'dokan-cat-has-child' : '', "\" data-term-id=\"").concat(category.term_id, "\" data-taxonomy=\"product_cat\">\n                        <span class=\"dokan-product-category\">").concat(category.name, "</span>\n                        <span class=\"dokan-product-category-icon\"><i class=\"fas fa-chevron-right\"></i></span>\n                    </li>");
      });
      return html;
    },
    ...
    setCatId: function setCatId(id) {
      var ui = "<input type=\"hidden\" name=\"".concat(dokan_product_category_data.is_single ? 'product_cat' : 'product_cat[]', "\" class=\"dokan_product_cat\" id=\"dokan_product_cat\" value=\"").concat(id, "\"></input>");
      ui += "<input type=\"hidden\" class=\"dokan_chosen_product_cat\" name=\"chosen_product_cat[]\" value=\"".concat(id, "\"></input>");
      console.log(id);
      var category = dokan_product_category_data.categories[id];

      if (!dokan_product_category_data.is_single) {
        ui += category.parents.map(function (element) {
          return "<input type=\"hidden\" name=\"product_cat[]\" class=\"dokan_product_cat\" id=\"dokan_product_cat\" value=\"".concat(element, "\"></input>");
        }).join('');
      }
