...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
    <th class="dokan-product-select check-column">
        ...
        <input class="cb-select-items dokan-checkbox" type="checkbox" data-product-name="<?php echo esc_html( $product->get_title() ); ?>" name="bulk_products[]" value="<?php echo esc_attr( $post->ID ); ?>">
    </th>
