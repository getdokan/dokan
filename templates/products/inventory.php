<div class="dokan-product-inventory dokan-edit-row <?php echo esc_attr( $class ); ?>">
    ...
    <div class="dokan-section-content">
        ...
        <div class="content-half-part hide_if_variable hide_if_auction">
        ...
        <div class="dokan-form-group hide_if_variation hide_if_grouped hide_if_auction">
            <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => __( 'Enable product stock management', 'dokan-lite' ) ), 'checkbox' ); ?>
        </div>

        <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix hide_if_auction">
        ...
        <div class="dokan-form-group hide_if_grouped hide_if_auction">
