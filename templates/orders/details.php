        ...
        <div class="dokan-clearfix">
            <div class="" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php printf( __( 'Order', 'dokan-lite' ) . '#%d', dokan_cmp_get_prop( $order, 'id' ) ); ?></strong> &rarr; <?php _e( 'Order Items', 'dokan-lite' ); ?></div>
                    ...
                    <div class="dokan-panel-body general-details">
                        <ul class="list-unstyled order-status">
                            ...
                            <li class="dokan-hide">
                                <form id="dokan-order-status-form" action="" method="post">
                                    ...
                                    <input type="hidden" name="order_id" value="<?php echo dokan_cmp_get_prop( $order, 'id' ); ?>">
                        ...
                        <ul class="list-unstyled customer-details">
                            <li>
                                ...
                                <?php
                                $customer_user = absint( get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_customer_user', true ) );
                                if ( $customer_user && $customer_user != 0 ) {
                                    $customer_userdata = get_userdata( $customer_user );
                                    $display_name =  $customer_userdata->display_name;
                                } else {
                                    $display_name = get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_billing_first_name', true ). ' '. get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_billing_last_name', true );
                                }
                                ?>
                            ...
                            <li>
                                ...
                                <?php echo esc_html( get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_billing_email', true ) ); ?>
                            </li>
                            <li>
                                <span><?php _e( 'Phone:', 'dokan-lite' ); ?></span>
                                <?php echo esc_html( get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_billing_phone', true ) ); ?>
                            </li>
                            <li>
                                <span><?php _e( 'Customer IP:', 'dokan-lite' ); ?></span>
                                <?php echo esc_html( get_post_meta( dokan_cmp_get_prop( $order, 'id' ), '_customer_ip_address', true ) ); ?>
                            </li>
                        </ul>

                        <?php
                        if ( get_option( 'woocommerce_enable_order_comments' ) != 'no' ) {
                            $customer_note = get_post_field( 'post_excerpt', dokan_cmp_get_prop( $order, 'id' ) );
                        ...
                        <div class="add_note">
                            ...
                            <form class="dokan-form-inline" id="add-order-note" role="form" method="post">
                                ...
                                <div class="clearfix">
                                    ...
                                    <input type="hidden" name="post_id" value="<?php echo dokan_cmp_get_prop( $order, 'id' ); ?>">
                            ...
                            <div class="clearfix dokan-form-group" style="margin-top: 10px;">
                                ...
                                <input type="button" data-toggle="modal" data-target="#tracking-modal" id="add-tracking-number" name="add_tracking_number" class="dokan-btn dokan-btn-success grant_access" value="<?php esc_attr_e( 'Tracking Number', 'dokan-lite' ); ?>">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h2 class="modal-title" id="myModalLabel"><?php _e('Shipment Tracking', 'dokan-lite');?></h2>
                                        </div>
                                        <form id="add-shipping-tracking-form" method="post">
                                            <div class="modal-body">
                                                <h5><?php _e('Shipping Provider Name / URL', 'dokan-lite');?></h5>
                                                <input type="text" name="shipping_provider" id="shipping_provider" value="">
                                                <h5><?php _e('Tracking Number', 'dokan-lite');?></h5>
                                                <input type="text" name="tracking_number" id="tracking_number" value="">
                                                <h5><?php _e('Date Shipped', 'dokan-lite');?></h5>
                                                ...
                                                <input type="hidden" name="post_id" id="post-id" value="<?php echo dokan_cmp_get_prop( $order, 'id' ); ?>">
                                                <input type="hidden" name="action" id="action" value="dokan_add_shipping_tracking_info">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal"><?php _e('Close', 'dokan-lite');?></button>
