                    ...
                    <div class="dokan-panel-body general-details">
                        <ul class="list-unstyled order-status">
                            <li>
                                ...
                                <label class="dokan-label dokan-label-<?php echo dokan_get_order_status_class( dokan_get_prop( $order, 'status' ) ); ?>"><?php echo esc_html__( dokan_get_order_status_translated( dokan_get_prop( $order, 'status' ) ) ); ?></label>
