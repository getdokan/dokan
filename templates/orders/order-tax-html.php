...
<div class="tax_row" data-order_item_id="<?php echo $item_id; ?>">
	<p class="wide">
		<label><?php _e( 'Tax Rate:', 'dokan-lite' ) ?></label>
		<select name="order_taxes_rate_id[<?php echo $item_id; ?>]">
			<option value=""><?php _e( 'N/A', 'dokan-lite' ); ?></option>
	...
	<p class="first">
		<label><?php _e( 'Sales Tax:', 'dokan-lite' ) ?></label>
	...
	<p class="last">
		<label><?php _e( 'Shipping Tax:', 'dokan-lite' ) ?></label>
