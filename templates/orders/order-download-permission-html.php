...
<div class="dokan-panel dokan-panel-default">
	<div class="dokan-panel-heading">
		<a class="title" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?php echo dokan_cmp_get_prop( $product, 'id' ); ?>">
	...
	<div id="collapse-<?php echo dokan_cmp_get_prop( $product, 'id' ); ?>" class="panel-collapse collapse">
