        ...
        <article class="dashboard-content-area">
            <div id="dokan-vendor-dashboard-root" class="dokan-layout">
                <div class="h-48 flex justify-center items-center" role="status">
                    <svg aria-hidden="true" class="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="var(--dokan-button-secondary-border-color)" xmlns="http://www.w3.org/2000/svg">
