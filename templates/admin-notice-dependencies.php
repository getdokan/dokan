...
<div class="dokan-woocommerce-missing-notice alert notice">
...
<style>
    ...
    .dokan-woocommerce-missing-notice.alert {
    ...
    .dokan-woocommerce-missing-notice .logo-wrap .logo {
        width: 60px;
        height: 60px;
    ...
    .dokan-woocommerce-missing-notice .logo-wrap .icon {
        width: 20px;
        height: 20px;
        position: absolute;
        top: -2px;
    ...
    .dokan-woocommerce-missing-notice .logo-wrap .icon-alert {
    ...
    .dokan-woocommerce-missing-notice .message {
        margin: 0 23px;
    }

    .dokan-woocommerce-missing-notice .message h3 {
        margin: 0 0 10px;
        font-weight: bold;
        font-size: 18px;
