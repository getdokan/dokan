...
<form method="post" id="store-form" action="" class="dokan-form-horizontal">
    ...
    <div class="dokan-banner">
        ...
        <div class="image-wrap<?php echo $banner_id ? '' : ' dokan-hide'; ?>">
            ...
            <input type="hidden" class="dokan-file-field" value="<?php echo esc_attr( $banner_id ); ?>"
                   name="dokan_banner">
        ...
        <div class="button-area<?php echo $banner_id ? ' dokan-hide' : ''; ?>">
            ...
            <a href="#"
               class="dokan-banner-drag dokan-btn dokan-btn-info dokan-theme"><?php esc_html_e( 'Upload banner', 'dokan-lite' ); ?></a>
            <p class="help-block">
                <?php
                /**
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label"
               for="dokan_gravatar"><?php esc_html_e( 'Profile Picture', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-w5 dokan-gravatar">
            <div class="dokan-left gravatar-wrap<?php echo $gravatar_id ? '' : ' dokan-hide'; ?>">
                ...
                <input type="hidden" class="dokan-file-field" value="<?php echo esc_attr( $gravatar_id ); ?>"
                       name="dokan_gravatar">
            ...
            <div class="gravatar-button-area<?php echo esc_attr( $gravatar_id ) ? ' dokan-hide' : ''; ?>">
                <a href="#" class="dokan-pro-gravatar-drag dokan-btn dokan-btn-default"><i
                        class="fa fa-cloud-upload"></i> <?php esc_html_e( 'Upload Photo', 'dokan-lite' ); ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label"
               for="dokan_store_name"><?php esc_html_e( 'Store Name', 'dokan-lite' ); ?></label>

        <div class="dokan-w5 dokan-text-left">
            <input id="dokan_store_name" required value="<?php echo esc_attr( $storename ); ?>" name="dokan_store_name"
                   placeholder="<?php esc_attr_e( 'store name', 'dokan-lite' ); ?>" class="dokan-form-control"
                   type="text">
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label"
               for="dokan_store_ppp"><?php esc_html_e( 'Store Product Per Page', 'dokan-lite' ); ?></label>

        <div class="dokan-w5 dokan-text-left">
            <input id="dokan_store_ppp" value="<?php echo esc_attr( $store_ppp ); ?>" name="dokan_store_ppp"
                   placeholder="10" class="dokan-form-control" type="number">
        </div>
    </div>
    <!--address-->
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label"
               for="setting_phone"><?php esc_html_e( 'Phone No', 'dokan-lite' ); ?></label>
        <div class="dokan-w5 dokan-text-left">
            <input id="setting_phone" value="<?php echo esc_attr( $phone ); ?>" name="setting_phone"
                   placeholder="<?php esc_attr_e( '+123456..', 'dokan-lite' ); ?>" class="dokan-form-control input-md"
                   type="text">
        </div>
    </div>
        ...
        <div class="dokan-w5 dokan-text-left">
            <div class="checkbox">
                <label>
                    ...
                    <input type="checkbox" name="setting_show_email"
                           value="yes"<?php checked( $show_email, 'yes' ); ?>> <?php esc_html_e( 'Show email address in store', 'dokan-lite' ); ?>
                </label>
            </div>
        </div>
    </div>
        ...
        <div class="dokan-w5 dokan-text-left">
            <div class="checkbox">
                <label>
                    ...
                    <input type="checkbox" name="setting_show_more_ptab"
                           value="yes"<?php checked( $show_more_ptab, 'yes' ); ?>> <?php esc_html_e( 'Enable tab on product single page view', 'dokan-lite' ); ?>
                </label>
            </div>
        </div>
    </div>
    ...
    <?php if ( dokan_has_map_api_key() ) { ?>
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label"
                   for="setting_map"><?php esc_html_e( 'Map', 'dokan-lite' ); ?></label>
    ...
    if ( $tnc_enable == 'on' ) :
        ...
        <div class="dokan-form-group">
            <label
                class="dokan-w3 dokan-control-label"><?php esc_html_e( 'Terms and Conditions', 'dokan-lite' ); ?></label>
            <div class="dokan-w5 dokan-text-left dokan_tock_check">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" id="dokan_store_tnc_enable"
                               value="on" <?php echo $enable_tnc == 'on' ? 'checked' : ''; ?>
                               name="dokan_store_tnc_enable"> <?php esc_html_e( 'Show terms and conditions in store page', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
        <div class="dokan-form-group" id="dokan_tnc_text">
            <label class="dokan-w3 dokan-control-label"
                   for="dokan_store_tnc"><?php esc_html_e( 'TOC Details', 'dokan-lite' ); ?></label>
    ...
    <?php if ( $show_store_open_close == 'on' ) : ?>
            ...
            <div class="dokan-w5 dokan-text-left dokan_tock_check">
                <div class="checkbox">
                    <label for="dokan-store-time-enable" class="control-label">
                        <input type="checkbox" name="dokan_store_time_enabled" id="dokan-store-time-enable"
                               value="yes" <?php echo $dokan_store_time_enabled == 'yes' ? 'checked' : ''; ?>>
            ...
            <div class="dokan-w6" style="width: auto">
                <?php foreach ( $dokan_days as $key => $day ) : ?>
                    ...
                    <div class="dokan-form-group">
                        ...
                        <label for="">
                            <select name="<?php echo esc_attr( $day ) ?>_on_off"
                                    class="dokan-on-off dokan-form-control">
                        ...
                        <div>
                            <label for="opening-time" class="time"
                                   style="visibility: <?php echo isset( $status ) && $status == 'open' ? 'visible' : 'hidden' ?>">
                                <input type="text" class="dokan-form-control"
                                       name="<?php echo esc_attr( strtolower( $day ) ); ?>_opening_time[]"
                                       id="<?php echo esc_attr( $day ) ?>-opening-time"
                                       placeholder="<?php echo esc_attr( date_i18n( get_option( 'time_format', 'g:i a' ), current_time( 'timestamp' ) ) ); ?>"
                                       value="<?php echo isset( $all_times[ $day ]['opening_time'] ) ? esc_attr( $all_times[ $day ]['opening_time'] ) : '' ?>">
                            </label>
                            <label for="closing-time" class="time"
                                   style="visibility: <?php echo isset( $status ) && $status == 'open' ? 'visible' : 'hidden' ?>">
                                <input type="text" class="dokan-form-control"
                                       name="<?php echo esc_attr( $day ) ?>_closing_time[]"
                                       id="<?php echo esc_attr( $day ) ?>-closing-time"
                                       placeholder="<?php echo esc_attr( date_i18n( get_option( 'time_format', 'g:i a' ), current_time( 'timestamp' ) ) ); ?>"
                                       value="<?php echo isset( $all_times[ $day ]['closing_time'] ) ? esc_attr( $all_times[ $day ]['closing_time'] ) : '' ?>">
                            </label>
                        </div>

                        <button type="button" class="add-shift time"
                                style="visibility: <?php echo isset( $status ) && $status == 'open' ? 'visible' : 'hidden' ?>">
        ...
        <div class="dokan-form-group store-open-close">
            ...
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" name="dokan_store_open_notice"
                           placeholder="<?php esc_attr_e( 'Store is open', 'dokan-lite' ) ?>"
                           value="<?php echo esc_attr( $dokan_store_open_notice ); ?>">
                </div>
            </div>
        </div>
        <div class="dokan-form-group store-open-close">
            ...
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" name="dokan_store_close_notice"
                           placeholder="<?php esc_attr_e( 'Store is closed', 'dokan-lite' ) ?>"
                           value="<?php echo esc_attr( $dokan_store_close_notice ); ?>">
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w4 ajax_prev dokan-text-left" style="margin-left:24%;">
            <input type="submit" name="dokan_update_store_settings" class="dokan-btn dokan-btn-danger dokan-btn-theme"
                   value="<?php esc_attr_e( 'Update Settings', 'dokan-lite' ); ?>">
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        $('.add-shift').on('click', function () {
            var self = $(this);
            var pe = self[0].previousElementSibling.cloneNode(true);
            $(pe).append("<button type='button' class='close-shift time'><span class='dashicons dashicons-dismiss'></span></button>");

            self[0].insertAdjacentElement('afterend', pe);
            call_timepicker()
        });

        $('form').on('click', '.close-shift', function () {
            var self = $(this);
            $(self[0].parentNode).remove();
        });
