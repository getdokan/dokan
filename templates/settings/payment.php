                    ...
                    <div id="vendor-payment-method-drop-down">
                        <?php if ( is_array( $unused_methods ) && ! empty( $unused_methods ) ) : ?>
                            ...
                            <?php foreach ( $unused_methods as $method_key => $method ) :?>
                                <li>
                                    <a href="<?php echo esc_url( dokan_get_page_url( 'dashboard' ) . 'settings/payment/manage-' . $method_key ); ?>">
                                        <div>
        ...
        <?php foreach ( $methods as $method_key => $method ) : ?>
            <li>
                <div>
                    ...
                    <div>
                        <a href="<?php echo esc_url(  dokan_get_page_url( 'dashboard' ) . 'settings/payment/manage-' . $method_key . '/edit' ); ?>">
