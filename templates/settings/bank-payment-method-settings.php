...
<div class="dokan-bank-settings-template">
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input id='ac_name' name="settings[bank][ac_name]" value="<?php echo esc_attr( $account_name ); ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Your bank account name', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['account_name'] ) && true === $required_fields['account_name'] ? 'required' : '' ?> >
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <select id='ac_type' name="settings[bank][ac_type]" class="dokan-form-control" <?php echo isset( $required_fields['account_type'] ) && true === $required_fields['account_type'] ? 'required' : '' ?>>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input name="settings[bank][ac_number]" value="<?php echo esc_attr( $account_number ); ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Account number', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['account_number'] ) && true === $required_fields['account_number'] ? 'required' : '' ?>>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input name="settings[bank][routing_number]" value="<?php echo esc_attr( $routing_number ); ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Routing number', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['routing_number'] ) && true === $required_fields['routing_number'] ? 'required' : '' ?>>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input name="settings[bank][bank_name]" value="<?php echo esc_attr( $bank_name ); ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Name of bank', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['bank_name'] ) && true === $required_fields['bank_name'] ? 'required' : '' ?>>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <textarea name="settings[bank][bank_addr]" rows="5" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Address of your bank', 'dokan-lite' ); ?>" <?php echo isset( $required_fields['bank_addr'] ) && true === $required_fields['bank_addr'] ? 'required' : '' ?>><?php echo esc_html( $bank_addr ); ?></textarea>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input name="settings[bank][iban]" value="<?php echo esc_attr( $iban ); ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'IBAN', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['iban'] ) && true === $required_fields['iban'] ? 'required' : '' ?>>
        </div>
    </div>
    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w10">
            <input value="<?php echo esc_attr( $swift_code ); ?>" name="settings[bank][swift]" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Swift code', 'dokan-lite' ); ?>" type="text" <?php echo isset( $required_fields['swift_code'] ) && true === $required_fields['swift_code'] ? 'required' : '' ?>>
        </div>
    </div>
