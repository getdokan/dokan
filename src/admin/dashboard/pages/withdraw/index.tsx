    ...
    const fields = [
        ...
        },
        {
            ...
            render: ({ item }) => {
                ...
                return (
                    <span
                        className={`inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-medium ${statusColors[item.status] ||
        ...
        <button
            ...
            onClick={async () => {
                ...
                try {
                    ...
                    alert(
                        __('Export failed. Please try again.', 'dokan-lite')
                    );
                } finally {
    ...
    const pollExportStatus = async (exportId) => {
        ...
        const checkStatus = async (resolve) => {
            try {
                ...
                if (statusResponse.percent_complete) {
                    setExportProgress(statusResponse.percent_complete);
                }
