...
const CategoryBasedCommission = ( {
    ...
    useEffect( () => {
        ...
        setRenderCategories(
            Object.values( getCategories( element.categories ) )
        );

        if (
            element?.commission?.items &&
            Object.values( element.commission.items ).length
        ) {
    ...
    return (
        <div className="p-4 flex flex-col gap-y-4 @container/commission">
            ...
            <div className="relative">
                ...
                <div
                    className={ `flex flex-col max-h-[500px] overflow-y-auto border-[1px] text-[14px] border-[#e9e9ea] border-solid ${
                            ...
                            ( item, index ) =>
                                showCatRow( item ) && (
                                    ...
                                    >
                                        ...
                                        <div className="@xl/commission:w-1/2 w-auto flex min-h-[3rem] border-0 border-solid border-[#e9e9ea]">
                                            <div className=" @xl/commission:w-1/2 w-auto flex justify-start items-center box-border">
                                                <SimpleInput
