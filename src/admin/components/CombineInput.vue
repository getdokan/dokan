<template>
    <div class="dokan-category-commission">
        <div
            ...
            <div
                class="md:shadow-md  border-[#E9E9E9] d-xs:!border-r-0 rounded-[5px] d-xs:!rounded-r-none md:!rounded-r-[5px] !p-0 !m-0 w-[110px] flex justify-start items-center box-border">
                <input
                    :id="percentageId"
                    ref="percentage"
                    :name="percentageName"
                ...
                />
                <div
                    class="d-xs:border-l-0 flex justify-center items-center d-xs:!bg-transparent md:!bg-gray-100 !min-h-full">
            ...
            <div
                class="md:shadow-md d-xs:!border-l-0 rounded-[5px] d-xs:!rounded-l-none md:!rounded-l-[5px] !p-0 !m-0 w-[110px] flex justify-start items-center box-border">
                <div
                    class="d-xs:border-r-0 flex justify-center items-center d-xs:!bg-transparent md:!bg-gray-100 !min-h-full">
