<template>
    ...
    >
        ...
        <template
            v-if="
                'price' === fieldData.type &&
                allSettingsValues.dokan_selling &&
                'combine' !== allSettingsValues.dokan_selling.commission_type
            "
        >
            <div
                class="field_contents"
        ...
        <template
            v-if="
                'combine' === fieldData.type &&
                haveCondition( fieldData ) &&
                fieldData.condition.type == 'show' &&
                        ...
                        <div class="fixed_fee">
                            ...
                            <input
                                ...
                                :name="
                                    sectionId +
                                    '[' +
                                    fieldData.fields.fixed_fee.name +
                                    ']'
                                "
                                v-model="
                                    fieldValue[
                ...
                <fieldset>
                    ...
                    <div class="field">
                        <color-picker
                            ...
                            @custom-change="
                                ( e ) => setCustomColor( e, fieldData.name )
                            "
        ...
        <template v-if="'withdraw-methods' === fieldData.type">
            <withdraw-methods
...
import WithdrawMethods from 'admin/components/Fields/WithdrawMethods.vue';
