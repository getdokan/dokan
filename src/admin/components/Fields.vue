<template>
    <div
        :class="[ id, `dokan-settings-field-type-${ fieldData.type }` ]"
        v-if="shouldShow"
    >
        <template v-if="'sub_section' === fieldData.type">
            <div
                :ref="fieldData.name"
                class="dokan-settings-sub-section"
                v-bind:class="[
        ...
        <template v-if="containCommonFields( fieldData.type )">
            ...
            >
                            ...
                            :class="[
                                {
                                    'dokan-input-validation-error':
                                        hasValidationError( fieldData.name ),
                                },
                                fieldData.class,
                            ]"
                            :name="sectionId + '[' + fieldData.name + ']'"
                ...
                <p
                    v-if="hasValidationError( fieldData.name )"
                    class="dokan-error"
                >
        ...
        <template v-if="'commission_fixed' === fieldData.type">
            ...
            >
                <fieldset class="flex justify-between">
                    ...
                    <combine-input
                        :value="{
                            fixed: fieldData.fields
                                ? fieldValue[ fieldData.fields.fixed_fee.name ]
                                : '',
                            percentage: fieldData.fields
                                ? fieldValue[
                                      fieldData.fields.percent_fee.name
                                  ]
                                : '',
                        }"
                ...
                <p
                    class="dokan-error combine-commission"
                    v-if="
                        hasError( fieldData.fields.percent_fee.name ) &&
                        hasError( fieldData.fields.fixed_fee.name )
                    "
                >
                    {{
                        __(
                ...
                <p
                    v-else-if="hasError( fieldData.fields.percent_fee.name )"
                    class="dokan-error combine-commission"
                >
                    {{ getError( fieldData.fields.percent_fee.label ) }}
                </p>
                <p
                    v-else-if="hasError( fieldData.fields.fixed_fee.name )"
                    class="dokan-error combine-commission"
                >
            ...
            >
                ...
                <div class="p-4 pl-5 pr-5">
                    <category-based-commission
                        ...
                        :resetSubCategory="
                            fieldValue?.reset_sub_category_when_edit_all_category &&
                            fieldValue?.reset_sub_category_when_edit_all_category ===
                                'on'
                        "
                    />
                ...
                <p
                    v-if="hasError( fieldData.name )"
                    class="dokan-error pt-0 pl-5 pb-5 m-0"
                >
                    {{ getError( fieldData.label ) }}
                </p>
                <p
                    v-if="hasValidationError( fieldData.name )"
                    class="dokan-error pl-5 pb-5"
                >
                    {{ getValidationErrorMessage( fieldData.name ) }}
                </p>
            </div>
                        ...
                        >
                            <div :key="optionKey">
                                ...
                                <switches
                                    ...
                                    :enabled="
                                        multiCheckValues.hasOwnProperty(
                                            optionKey
                                        ) &&
                                        multiCheckValues[ optionKey ] !== ''
                                    "
                                    :value="optionKey"
                                ></switches>
                            </div>
        ...
        <template v-if="'croppable_image' === fieldData.type">
            ...
            >
                <fieldset>
                    ...
                    <div class="field add_files">
                        <label
                            :style="{ maxWidth: fieldData.render_width + 'px' }"
                            :for="sectionId + '[' + fieldData.name + ']'"
                        >
                            <UploadImage
            ...
            >
                <fieldset>
                    <div class="field_data">
                        <h3
                            scope="row"
                            class="field_heading dokan-setting-warning error"
                        >
                            ...
                            <span
                                class="field_desc"
                                v-html="fieldData.desc"
                            ></span>
                            <a
                                v-if="fieldData.scroll_into_view"
                                class="dokan-setting-warning-link"
                                @click.prevent="
                                    scrollIntoField(
                                        fieldData.scroll_to_field,
                                        fieldData.scroll_to_section
                                    )
                                "
                                href="#"
                                >{{ fieldData.scroll_to_label }}
                                <i class="dashicons dashicons-admin-links"></i
                            ></a>
                            <a
                                v-else-if="fieldData.external_link"
                                class="dokan-setting-warning-link"
                                :href="fieldData.link_url"
                                >{{ fieldData.link_text }}
                                <i class="dashicons dashicons-admin-links"></i
                            ></a>
                        </h3>
        ...
        <template v-if="'wpeditor' === fieldData.type">
            ...
            >
                ...
                <div class="field editor_field">
                    <text-editor
                        :value="
                            fieldValue[ fieldData.name ] ?? fieldData.default
                        "
                        @input="
                            ( data ) =>
                                inputValueHandler(
            ...
            >
                <fieldset>
                    ...
                    <div class="field repeatable_fields">
                        ...
                        <a
                            href="#"
                            class="button dokan-repetable-add-item-btn"
                            @click.prevent="
                                addItem( fieldData.type, fieldData.name )
                            "
                        >
                ...
                <ul class="dokan-settings-repeatable-list">
                    <template
                        v-for="(optionVal, optionKey) in fieldValue[
                            fieldData.name
                        ]"
                    >
                        <li
                            v-if="fieldValue[ fieldData.name ]"
                            :key="optionKey"
                        >
                            {{ optionVal.value }}
                            <span
                                ...
                                @click.prevent="
                                    removeItem( optionKey, fieldData.name )
                                "
                            ></span>
                            <span
                                class="repeatable-item-description"
                                v-html="optionVal.desc"
                            ></span>
                        </li>
                    </template>
                </ul>
                ...
                <div class="field radio-image-container">
                    <template v-for="(image, name) in fieldData.options">
                        <label
                            ...
                            :key="name"
                            :class="{
                                active: fieldValue[ fieldData.name ] === name,
                                'not-active':
                                    fieldValue[ fieldData.name ] !== name,
                            }"
                        >
                            <input
                                type="radio"
        ...
        <template v-if="'social' === fieldData.type">
            ...
            >
                <fieldset>
                    <FieldHeading :fieldData="fieldData"></FieldHeading>
                    <label
                        class="social-switch-wraper"
                        v-if="fieldData.enable_status"
                    >
                        <switches
                ...
                <div
                    class="field scl_fields"
                    :class="
                        fieldData.enable_status && 'off' === socialChecked
                            ? 'scl_fields_disable'
                            : ''
                    "
                >
                    ...
                    <template v-for="(fields, index) in fieldData">
                        <div
                            class="scl_info"
                            v-if="expandSocials && fields.social_field"
                            :key="index"
                        >
                            <div
                                :class="[
...
export default {
    ...
    data() {
        return {
            ...
            yourStringTimeValue: '',
            customFieldComponents: dokan.hooks.applyFilters(
                'getDokanCustomFieldComponents',
                []
            ),
            commissionFieldComponents: dokan.hooks.applyFilters(
                'getDokanCommissionFieldComponents',
                []
            ),
            multiCheckValues: {},
    ...
    computed: {
        shouldShow( e ) {
            ...
            if ( this.fieldData.show_if ) {
                ...
                for ( i = 0; i < dependencies.length; i++ ) {
                    ...
                    const [ optionId, sectionId = this.sectionId ] = dependency
                        .split( '.' )
                        .reverse();
                    const dependencyValue =
                        this.allSettingsValues[ sectionId ][ optionId ];
                    const [ operator, value ] = _.chain(
                    ...
                    switch ( operator ) {
                        ...
                        case 'contains':
                            if (
                                ! Object.values( dependencyValue ).includes(
                                    value
                                )
                            ) {
                                shouldShow = false;
        ...
        mapboxAccessToken() {
            return this.allSettingsValues?.dokan_appearance
                ?.mapbox_access_token;
        },
        ...
        isSocialFieldActivated() {
            for ( const data in this.fieldData ) {
                if (
                    this.fieldData[ data ].social_field &&
                    'html' !== this.fieldData[ data ].type &&
                    ! this.fieldValue[ this.fieldData[ data ].name ]
                ) {
                    return false;
                }
            }
        ...
        watchCategoryCommission() {
            let data = JSON.parse(
                JSON.stringify( this.fieldValue[ this.fieldData.name ] )
            );
    ...
    beforeMount() {
        ...
        if ( 'multicheck' === this.fieldData.type ) {
            this.multiCheckValues = JSON.parse(
                JSON.stringify( this.fieldValue[ this.fieldData.name ] )
            );
        }
    },
    ...
    methods: {
        ...
        uploadedImage( image ) {
            this.fieldValue[ this.id ] = this.validateInputData(
                this.id,
                image.src,
                this.fieldValue[ this.id ],
                this.fieldData
            );
        },
        ...
        validateCustomStoreUrl( value ) {
            ...
            if ( reservedSlugs.includes( value ) ) {
                ...
                this.$emit( 'addValidationError', {
                    ...
                    error: this.__(
                        'The store URL "%s" is reserved by WordPress and cannot be used. Please choose a different value like "store".',
                        'dokan-lite'
                    ).replace( '%s', value ),
                } );
            }
        ...
        inputValueHandler( name, newValue, oldValue ) {
            ...
            this.fieldValue[ name ] = this.validateInputData(
                name,
                newValue,
                oldValue,
                this.fieldData
        ...
        containCommonFields( type ) {
            return _.contains(
                [ undefined, 'text', 'email', 'url', 'phone', 'time' ],
                type
            );
        },
        ...
        addItem( type, name ) {
            ...
            if (
                typeof this.repeatableItem[ name ] == 'undefined' ||
            ...
            let oldData = JSON.parse(
                JSON.stringify( this.fieldValue[ name ] )
            );
            let newData = [
                ...oldData,
                {
                    id: this.repeatableItem[ name ]
                        .trim()
                        .replace( /\s+/g, '_' )
                        .toLowerCase(),
            ...
            newData = this.validateInputData(
                this.fieldData.name,
                newData,
                oldData,
                this.fieldData
        ...
        isSocialChecked() {
             ...
             */
            if (
                this.fieldData[ 'enable_status' ] &&
                this.fieldData[ 'enable_status' ][ 'name' ] &&
                this.fieldValue[ this.fieldData[ 'enable_status' ][ 'name' ] ]
            ) {
                ...
                this.fieldData[ 'enable_status' ] &&
                this.fieldData[ 'enable_status' ][ 'default' ]
            ) {
        ...
        getSocialValue( optionValue ) {
            this.fieldValue[ optionValue.name ] = this.fieldValue[
                optionValue.name
            ]
                ? this.fieldValue[ optionValue.name ]
                : '';
        },

        isChecked() {
            return ! this.fieldValue[ this.fieldData.name ]
        ...
        hasValidationError( key ) {
            if (
                this.validationErrors.filter( ( e ) => e.name === key ).length >
                0
            ) {
                return key;
            }
        ...
        toggleColorPicker( data ) {
            if ( this.fieldData.name === data.key ) {
                this.singleColorPicker.show_pallete =
                    ! data.values.show_pallete;
            } else {
        ...
        setCustomColor( value, key, defaultValue ) {
            ...
            this.fieldData[ key ] = hexPattern.test( value )
                ? value
                : defaultValue;
        },
        ...
        commissionUpdated( data ) {
            if ( isNaN( data.fixed ) ) {
                data.fixed =
                    this.fieldValue[ this.fieldData.fields.fixed_fee.name ] ??
                    '';
            }
            if ( isNaN( data.percentage ) ) {
                data.percentage =
                    this.fieldValue[ this.fieldData.fields.percent_fee.name ] ??
                    '';
            }
