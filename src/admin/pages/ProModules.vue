        ...
        <div class="dokan-modules-wrap">
            ...
            <div class="module-filter-wrap">
               <div class="module-filter-left">
                   ...
                   <div class="premium-modules-menu" v-else>
                       <div class="premium-modules-hint-wrap">
               ...
               <div class="module-filter-right">
                   ...
                   <div class="search-box-view-mode">
                       ...
                       <div class="search-box-responsive">
                           <input type="text" placeholder="Search..." v-model="search" @focus="isExpanded = true" @blur="isExpanded = false" :style="isExpanded ? 'width: 355px': ''">
            ...
            <div class="module-content">
                <div class="dokan-modules" v-if="isLoaded">
                    <div class="free-modules" :class="currentView" v-if="filteredModules.length > 0">
                    ...
                    <div class="not-found" v-else>
                        <svg width="298" height="156" viewBox="0 0 298 156" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.3" d="M297.658 90.9635C295.429 89.1719 292.229 89.6633 289.386 89.3768C287.451 89.1829 285.561 88.5791 283.871 87.6183C281.776 86.4283 279.643 84.6191 277.286 85.1215C276.074 85.3816 275.077 86.2278 273.935 86.7148C271.617 87.7021 268.928 87.1137 266.606 86.133C264.56 85.2692 262.416 84.0836 260.253 84.5861C259.392 84.7866 258.618 85.2405 257.85 85.6769C253.948 87.8872 249.835 89.7228 245.583 91.1508L297.658 90.9635Z" fill="#EBEBFF"/>
                            <path opacity="0.3" d="M135.07 25.8719C131.564 23.0534 126.529 23.8269 122.055 23.3773C119.013 23.071 116.038 22.1234 113.38 20.6117C110.083 18.7386 106.729 15.8936 103.023 16.6847C101.115 17.0924 99.5483 18.4257 97.7525 19.1903C94.1059 20.7417 89.8762 19.8184 86.2252 18.2758C83.0056 16.9161 79.6341 15.054 76.2296 15.8429C74.8762 16.1581 73.657 16.8743 72.4488 17.5596C66.3111 21.037 59.841 23.9238 53.1553 26.1694L135.07 25.8719Z" fill="#EBEBFF"/>
                            <path opacity="0.3" d="M82.0935 97.728C78.5878 94.9095 73.5526 95.683 69.0785 95.2334C66.0372 94.9271 63.0618 93.9795 60.4034 92.4678C57.1067 90.5947 53.7528 87.7497 50.0469 88.5408C48.1389 88.9485 46.572 90.2817 44.7762 91.0464C41.1296 92.5978 36.8999 91.6745 33.2489 90.1319C30.0293 88.7722 26.6578 86.9101 23.2533 87.699C21.8999 88.0141 20.6807 88.7303 19.4725 89.4157C13.3326 92.8931 6.86249 95.7821 0.176758 98.0277L82.0935 97.728Z" fill="#EBEBFF"/>
                            <path d="M129.026 153.001C129.026 153.001 108.641 122.485 115.439 111.089C122.237 99.6941 133.933 131.879 136.81 149.156L129.026 153.001Z" fill="url(#paint0_linear_1002_578)"/>
                            <path d="M135.055 150.504C135.055 150.504 125.48 125.228 132.153 117.863C138.825 110.498 141.954 135.746 141.213 148.809L135.055 150.504Z" fill="url(#paint1_linear_1002_578)"/>
                            <path d="M195.383 155.339C195.383 155.339 209.076 134.838 204.512 127.185C199.945 119.529 192.087 141.152 190.154 152.756L195.383 155.339Z" fill="url(#paint2_linear_1002_578)"/>
                            <path d="M191.331 153.662C191.331 153.662 197.764 136.682 193.281 131.735C188.798 126.788 186.697 143.747 187.196 152.525L191.331 153.662Z" fill="url(#paint3_linear_1002_578)"/>
                            <path d="M262.295 155.713C253.774 153.19 248.422 149.477 242.207 146.326C236.681 143.525 231.705 139.653 225.962 137.333C220.218 135.012 213.167 134.514 208.228 138.26C204.3 141.24 202.357 146.392 198.191 149.03C191.019 153.571 181.745 148.529 175.152 143.181C168.559 137.833 160.654 131.627 152.526 134.073C149.461 134.997 146.897 137.068 144.192 138.783C137.474 143.045 128.981 145.22 121.448 142.661C111.364 139.237 103.937 127.943 93.3187 128.732C86.6132 129.23 81.3975 134.532 76.8531 139.494C72.2008 144.574 67.5507 150.597 62.8984 155.674L262.295 155.713Z" fill="url(#paint4_linear_1002_578)"/>
                            <path d="M108.1 61.1143L111.392 59.499L114.079 64.9972L110.784 66.6103L108.1 61.1143Z" fill="url(#paint5_linear_1002_578)"/>
                            <path d="M102.819 66.7139L104.435 64.2017L108.614 66.8968L107.001 69.409L102.819 66.7139Z" fill="url(#paint6_linear_1002_578)"/>
                            <path d="M101.441 75.0437L101.263 72.0622L106.225 71.7625L106.406 74.744L101.441 75.0437Z" fill="url(#paint7_linear_1002_578)"/>
                            <path d="M214.942 50.9739L216.641 51.5887L215.618 54.4248L213.919 53.81L214.942 50.9739Z" fill="url(#paint8_linear_1002_578)"/>
                            <path d="M219.347 53.7952L220.714 54.9785L218.749 57.2616L217.38 56.0804L219.347 53.7952Z" fill="url(#paint9_linear_1002_578)"/>
                            <path d="M223.454 57.9399L224.061 59.6434L221.225 60.6571L220.617 58.9536L223.454 57.9399Z" fill="url(#paint10_linear_1002_578)"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M202.518 97.4385L201.903 99.1374L199.067 98.1141L199.682 96.4152L202.518 97.4385ZM199.697 101.842L198.513 103.209L196.23 101.244L197.412 99.875L199.697 101.842ZM193.848 106.558L195.551 105.95L194.537 103.114L192.834 103.721L193.848 106.558Z" fill="#DFC9DD"/>
                            <path opacity="0.1" d="M200.438 33.7631C201.738 33.7631 202.791 32.7084 202.791 31.4074C202.791 30.1063 201.738 29.0516 200.438 29.0516C199.139 29.0516 198.086 30.1063 198.086 31.4074C198.086 32.7084 199.139 33.7631 200.438 33.7631Z" fill="url(#paint11_linear_1002_578)"/>
                            <path d="M170.835 67.5728C172.134 67.5728 173.188 66.5181 173.188 65.2171C173.188 63.916 172.134 62.8613 170.835 62.8613C169.536 62.8613 168.482 63.916 168.482 65.2171C168.482 66.5181 169.536 67.5728 170.835 67.5728Z" fill="url(#paint12_linear_1002_578)"/>
                            <path opacity="0.1" d="M129.705 98.1197C130.615 98.1197 131.353 97.3807 131.353 96.4692C131.353 95.5576 130.615 94.8186 129.705 94.8186C128.795 94.8186 128.057 95.5576 128.057 96.4692C128.057 97.3807 128.795 98.1197 129.705 98.1197Z" fill="url(#paint13_linear_1002_578)"/>
                            <path d="M170.834 40.2384C171.355 40.2384 171.776 39.8161 171.776 39.2952C171.776 38.7743 171.355 38.3521 170.834 38.3521C170.314 38.3521 169.893 38.7743 169.893 39.2952C169.893 39.8161 170.314 40.2384 170.834 40.2384Z" fill="url(#paint14_linear_1002_578)"/>
                            <path d="M148.67 93.0386C149.678 93.497 149.827 92.0976 149.827 92.0976C150.851 92.2078 150.127 88.2786 150.085 88.0649C150.675 89.1822 151.716 89.2945 151.716 89.2945L150.492 84.2128C150.754 81.7624 148.923 79.0893 148.923 79.0893L149.471 75.1976L151.801 49.311C152.332 46.0076 145.725 44.3042 145.734 44.9477C145.8 50.9703 144.764 86.606 144.764 86.606L147.352 92.188C147.933 93.3096 148.67 93.0386 148.67 93.0386Z" fill="#FDBFBA"/>
                            <path d="M148.694 71.2131L149.273 101.67C149.115 102.622 149.117 103.594 149.282 104.544L156.998 149.179H167.026L161.128 103.993L166.729 71.2131H148.694Z" fill="url(#paint15_linear_1002_578)"/>
                            <path d="M167.762 155.531H148.002C148.002 155.531 146.294 152.968 153.22 150.636C153.475 150.55 153.726 150.444 153.963 150.314L156.849 148.739L167.467 148.443C167.471 148.441 167.762 155.531 167.762 155.531Z" fill="url(#paint16_linear_1002_578)"/>
                            <path d="M173.955 155.531H154.195C154.195 155.531 152.487 152.966 159.421 150.634C159.672 150.55 159.917 150.447 160.15 150.321L163.634 148.441H173.662C173.664 148.441 173.955 155.531 173.955 155.531Z" fill="url(#paint17_linear_1002_578)"/>
                            <path d="M173.807 74.4614L169.383 105.472L173.807 148.589H163.483L155.913 104.564C155.847 104.185 155.821 103.799 155.832 103.413L156.681 74.4592H173.807V74.4614Z" fill="url(#paint18_linear_1002_578)"/>
                            <path d="M164.194 16.1941L163.32 28.9645L155.902 29.3038L155.884 26.0446L155.88 25.2601L155.86 22.0956L155.858 22.003C155.823 21.9986 155.787 21.9942 155.754 21.9898C149.055 21.0004 151.463 4.77026 151.463 4.77026C158.659 1.53967 163.791 4.94435 165.528 9.67786C167.269 14.407 164.194 16.1941 164.194 16.1941Z" fill="#FDBFBA"/>
                            <path d="M147.793 32.6974L144.499 48.7203H150.146L147.793 32.6974Z" fill="url(#paint19_linear_1002_578)"/>
                            <path d="M178.076 37.2015C177.841 37.7899 177.623 38.3937 177.416 39.0195C174.417 48.0282 173.741 77.5663 173.741 77.5663L148.732 77.9431C148.737 77.8836 147.79 32.6972 147.79 32.6972C147.515 32.8779 155.413 27.6728 155.499 27.6023C160.332 30.6632 163.679 25.7688 163.679 25.7688C167.652 26.8178 173.173 28.5653 175.488 29.6274C175.565 29.6583 175.647 29.6936 175.728 29.7332C175.733 29.7376 175.735 29.7398 175.739 29.7398H175.744C175.755 29.7442 175.763 29.7486 175.774 29.7531C177.337 30.4737 178.422 31.9832 178.521 33.702C178.629 35.5443 178.076 37.2015 178.076 37.2015Z" fill="url(#paint20_linear_1002_578)"/>
                            <path d="M178.076 37.2014C177.841 37.7898 177.623 38.3936 177.416 39.0195C176.591 41.0534 175.519 43.4488 174.133 46.2387C172.744 49.0308 166.148 43.0654 166.148 43.0654L169.874 32.188C170.398 30.7336 171.628 29.6031 173.151 29.3453C173.846 29.2263 174.639 29.2704 175.49 29.6296C175.567 29.6604 175.649 29.6957 175.73 29.7353C175.735 29.7398 175.737 29.742 175.741 29.742H175.746C175.757 29.7464 175.765 29.7508 175.776 29.7552C177.339 30.4758 178.424 31.9853 178.523 33.7042C178.629 35.5442 178.076 37.2014 178.076 37.2014Z" fill="url(#paint21_linear_1002_578)"/>
                            <path d="M173.807 46.8866L171.69 49.9519L165.284 59.2272C163.477 61.843 159.421 61.0254 158.766 57.9116L157.003 49.509L155.947 43.0236L155.7 41.5207L154.54 34.3873C154.54 34.3873 152.434 32.2762 152.08 31.2184C152.08 31.2184 151.38 27.3532 151.728 26.648C152.08 25.9406 152.784 26.648 152.784 26.648C152.784 26.648 152.969 23.4968 152.969 22.7982C152.969 21.3834 153.088 21.3834 153.44 21.3834C154.38 21.3834 154.851 22.7982 154.892 25.2421L155.592 28.054L157.478 29.8984L157.348 27.3532C157.348 27.3532 159.102 27.0028 159.102 29.8125L158.405 32.6288L161.369 43.0258L163.321 49.6655L165.977 43.0236L166.171 43.1183L173.807 46.8866Z" fill="#FDBFBA"/>
                            <path d="M161.8 12.1435C161.8 12.1435 159.555 8.49864 160.801 6.81503C160.801 6.81503 154.382 11.608 151.303 6.96488C148.077 2.09695 154.756 -2.25752 162.68 2.45174C162.68 2.45174 164.971 1.72232 166.974 4.60254C166.974 4.60254 168.605 11.3061 163.794 18.0847V15.7289C163.794 15.7289 166.191 11.489 163.187 11.0593C163.187 11.0593 162.322 11.1364 161.8 12.1435Z" fill="#473765"/>
                            <path opacity="0.12" d="M162.242 19.2681C160.455 24.0985 157.317 25.597 155.887 26.0444L155.882 25.2599L155.862 22.0954L155.86 22.0028C155.825 21.9984 155.79 21.994 155.757 21.9896C159.042 21.6326 162.137 19.343 162.242 19.2681Z" fill="black"/>
                            <path opacity="0.12" d="M173.807 46.8868L171.692 49.9521L166.173 43.1185L173.807 46.8868Z" fill="black"/>
                            <defs>
                                <linearGradient id="paint0_linear_1002_578" x1="114.051" y1="108.703" x2="114.051" y2="153.001" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C1E3FF"/>
                                    <stop offset="1" stop-color="#6F88FC"/>
                                </linearGradient>
                                <linearGradient id="paint1_linear_1002_578" x1="129.789" y1="116.542" x2="129.789" y2="150.504" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C1E3FF"/>
                                    <stop offset="1" stop-color="#6F88FC"/>
                                </linearGradient>
                                <linearGradient id="paint2_linear_1002_578" x1="190.154" y1="125.581" x2="190.154" y2="155.339" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C1E3FF"/>
                                    <stop offset="1" stop-color="#6F88FC"/>
                                </linearGradient>
                                <linearGradient id="paint3_linear_1002_578" x1="187.124" y1="130.848" x2="187.124" y2="153.662" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C1E3FF"/>
                                    <stop offset="1" stop-color="#6F88FC"/>
                                </linearGradient>
                                <linearGradient id="paint4_linear_1002_578" x1="62.8984" y1="128.692" x2="62.8984" y2="155.713" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C2E998"/>
                                    <stop offset="1" stop-color="#02CC87"/>
                                </linearGradient>
                                <linearGradient id="paint5_linear_1002_578" x1="108.099" y1="63.0553" x2="114.079" y2="63.0553" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F46595"/>
                                    <stop offset="1" stop-color="#F89597"/>
                                </linearGradient>
                                <linearGradient id="paint6_linear_1002_578" x1="102.82" y1="66.8048" x2="108.615" y2="66.8048" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F46595"/>
                                    <stop offset="1" stop-color="#F89597"/>
                                </linearGradient>
                                <linearGradient id="paint7_linear_1002_578" x1="101.263" y1="73.4031" x2="106.405" y2="73.4031" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F46595"/>
                                    <stop offset="1" stop-color="#F89597"/>
                                </linearGradient>
                                <linearGradient id="paint8_linear_1002_578" x1="213.919" y1="52.7003" x2="216.642" y2="52.7003" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#EA84DE"/>
                                    <stop offset="1" stop-color="#C352F7"/>
                                </linearGradient>
                                <linearGradient id="paint9_linear_1002_578" x1="217.38" y1="55.5287" x2="220.715" y2="55.5287" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#EA84DE"/>
                                    <stop offset="1" stop-color="#C352F7"/>
                                </linearGradient>
                                <linearGradient id="paint10_linear_1002_578" x1="220.618" y1="59.2989" x2="224.062" y2="59.2989" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#EA84DE"/>
                                    <stop offset="1" stop-color="#C352F7"/>
                                </linearGradient>
                                <linearGradient id="paint11_linear_1002_578" x1="198.086" y1="31.4075" x2="202.793" y2="31.4075" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint12_linear_1002_578" x1="168.482" y1="65.217" x2="173.189" y2="65.217" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint13_linear_1002_578" x1="128.059" y1="96.4685" x2="131.353" y2="96.4685" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint14_linear_1002_578" x1="169.894" y1="39.2949" x2="171.777" y2="39.2949" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint15_linear_1002_578" x1="139.528" y1="110.196" x2="174.271" y2="118.365" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#6B73FF"/>
                                    <stop offset="1" stop-color="#000DFF"/>
                                </linearGradient>
                                <linearGradient id="paint16_linear_1002_578" x1="160.388" y1="151.986" x2="140.441" y2="151.986" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint17_linear_1002_578" x1="179.917" y1="151.986" x2="159.971" y2="151.986" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint18_linear_1002_578" x1="146.84" y1="111.524" x2="180.798" y2="119.76" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#6B73FF"/>
                                    <stop offset="1" stop-color="#000DFF"/>
                                </linearGradient>
                                <linearGradient id="paint19_linear_1002_578" x1="146.506" y1="41.2214" x2="160.338" y2="60.8418" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint20_linear_1002_578" x1="165.054" y1="76.8888" x2="162.896" y2="45.1048" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                                <linearGradient id="paint21_linear_1002_578" x1="173.013" y1="48.8255" x2="171.755" y2="29.5019" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2B0246"/>
                                    <stop offset="1" stop-color="#6A4586"/>
                                </linearGradient>
                            </defs>
                        </svg>
                        <h5>{{ __( 'No modules found.', 'dokan-lite' ) }}</h5>
                        <p>{{ __( 'According to your search, system didn\'t get any result.', 'dokan-lite' ) }}</p>
                        <a href="#" @click.prevent="resetFilters">{{ __( 'See All Modules', 'dokan-lite' ) }}</a>
                    </div>
...
export default {
    ...
    methods: {
        ...
        onSwitch( status, moduleSlug ) {
            ...
            if ( status ) {
                // Need to activate
                let message = moduleData.name + this.__( 'is successfully activated', 'dokan-lite' );
                ...
                // Need to deactivate
                let message = moduleData.name + this.__( 'is successfully deactivated', 'dokan-lite' );
        ...
        onBulkAction( action ) {
            ...
            if ( 'activate' === action ) {
                ...
                message = this.__( 'All selected modules are successfully activated', 'dokan-lite' );
            } else {
                this.is_deactivating = true;
                message = this.__('All selected modules are successfully deactivated', 'dokan-lite');
            }
