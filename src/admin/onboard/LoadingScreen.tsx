        ...
        <OnboardingLayout className={ `!bg-transparent shadow-none` }>
            <div className='flex flex-col items-center justify-center py-16 px-6 text-center'>
                <div className='mb-8'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="183" height="183"
                        ...
                        <path
                            ...
                            fill="url(#C)"/>
                        <defs>
                            <linearGradient id="A" x1="83.652" y1="50.068" x2="83.652" y2="81.358" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#5711cf"/>
                                <stop offset="1" stopColor="#800bd1"/>
                            </linearGradient>
                            <linearGradient id="B" x1="121.481" y1="59.395" x2="83.084" y2="133.789" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#fe9879"/>
                                <stop offset="1" stopColor="#fe7598"/>
                            </linearGradient>
                            <linearGradient id="C" x1="105.911" y1="57.58" x2="76.154" y2="128.614" gradientUnits="userSpaceOnUse">
                ...
                <div className='flex items-center space-x-3 mb-6'>
                    <svg className='animate-spin h-5 w-5 text-indigo-600' xmlns='http://www.w3.org/2000/svg' fill='none'
                         viewBox='0 0 24 24'>
