...
const FeatureComparison = () => {
    const featureData: Record< string, FeatureData > = {
        vendor: {
            ...
            lite: [ true, true, true, false, false, false, false, false, false ],
        ...
        payment: {
            ...
            lite: [ true, false, false, false, false, false, false, false, false ],
            pro: [ true, true, true, true, true, true, true, true, true ],
        },
        sales: {
            features: [
            ...
            lite: [ true, false, false, false, false, false, false, false, false, false ],
