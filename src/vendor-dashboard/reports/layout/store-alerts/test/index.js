...
import { setAdminSetting } from "reports/utils/admin-settings";
...
describe("StoreAlerts", () => {
  ...
  it("should show the alert title and content", () => {
    ...
    expect(container.querySelector("h2").textContent).toBe("Alert title 1");
    expect(
      container.querySelector(".woocommerce-store-alerts__message").textContent
  ...
  it("should show different alerts when clicking the pagination buttons", () => {
    ...
    expect(container.querySelector("h2").textContent).toBe("Alert title 2");
