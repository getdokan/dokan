      ...
      subFilters: [
        {
          ...
          settings: {
            ...
            labels: {
              placeholder: __("Type to search for a product", 'dokan'),
              button: __("Single product", 'dokan'),
            },
          },
        },
      ],
    },
    {
      ...
      settings: {
        ...
        labels: {
          ...
          placeholder: __("Search for products to compare", 'dokan'),
          title: __("Compare Products", 'dokan'),
      ...
      subFilters: [
        {
          ...
          settings: {
            ...
            labels: {
              placeholder: __("Type to search for a variation", 'dokan'),
