        ...
        subFilters: [
          {
            ...
            settings: {
              ...
              labels: {
                placeholder: __("Type to search for a customer", "woocommerce"),
    ...
    filters: {
      name: {
        labels: {
          ...
          rule: __("Select a customer name filter match", "woocommerce"),
          /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
          title: __("<title>Name</title> <rule/> <filter/>", "woocommerce"),
      ...
      country: {
        labels: {
          ...
          rule: __("Select a country / region filter match", "woocommerce"),
          /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
          title: __(
      ...
      username: {
        labels: {
          ...
          remove: __("Remove customer username filter", "woocommerce"),
          rule: __("Select a customer username filter match", "woocommerce"),
          /* translators: A sentence describing a customer username filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
          title: __("<title>Username</title> <rule/> <filter/>", "woocommerce"),
        ...
        rules: [
          {
            ...
            label: _x("Includes", "customer usernames", "woocommerce"),
          },
          {
            value: "excludes",
            ...
            label: _x("Excludes", "customer usernames", "woocommerce"),
          },
        ],
        input: {
          component: "Search",
      ...
      orders_count: {
        labels: {
          ...
          rule: __("Select an order count filter match", "woocommerce"),
          title: __(
        ...
        rules: [
          {
            ...
            label: _x("Less Than", "number of orders", "woocommerce"),
          },
          {
            value: "min",
            ...
            label: _x("More Than", "number of orders", "woocommerce"),
          },
          {
            value: "between",
      ...
      total_spend: {
        labels: {
          ...
          rule: __("Select a total spend filter match", "woocommerce"),
          title: __(
        ...
        rules: [
          {
            ...
            label: _x("Less Than", "total spend by customer", "woocommerce"),
          },
          {
            value: "min",
            ...
            label: _x("More Than", "total spend by customer", "woocommerce"),
          },
          {
            value: "between",
            ...
            label: _x("Between", "total spend by customer", "woocommerce"),
          },
        ],
        input: {
          component: "Currency",
      ...
      avg_order_value: {
        labels: {
          ...
          remove: __("Remove average order value filter", "woocommerce"),
          rule: __("Select an average order value filter match", "woocommerce"),
          title: __("<title>AOV</title> <rule/> <filter/>", "woocommerce"),
        },
        rules: [
          {
            value: "max",
      ...
      last_active: {
        labels: {
          ...
          rule: __("Select a last active filter match", "woocommerce"),
          /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
          title: __(
