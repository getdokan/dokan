...
const EXPERIMENTAL_VARIATIONS_REPORT_TABLE_SUMMARY_VARIATIONS_COUNT_LABEL_FILTER =
  "experimental_dokan_analytics_variations_report_table_summary_variations_count_label";
...
class VariationsReportTable extends Component {
  ...
  getRowsContent(data = []) {
    ...
    return map(data, (row) => {
      ...
      return [
        ...
        {
          display: formatValue(getCurrencyConfig(), "number", itemsSold),
          value: itemsSold,
        },
        {
    ...
    return [
      {
         ...
         *
         * @filter experimental_dokan_analytics_variations_report_table_summary_variations_count_label
         *
  ...
  render() {
    const { advancedFilters, baseSearchQuery, filters, isRequesting, query } =
      this.props;
    ...
    return (
      <ReportTable
         ...
         *
         * @filter experimental_dokan_analytics_variations_report_table_title
         *
