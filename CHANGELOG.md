### v4.1.0 ( Oct 01, 2025 ) ###
- **feat:** Implement a new React-based admin dashboard with enhanced metrics and legacy dashboard support.
- **update:** Migrate Pro Features page from Vue to React with enhanced UI.
